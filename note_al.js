...
- 반복 횟수가 최대 횟수가 아니면 현재 입력 벡터를 처음 벡터 설정하고 재수행 \
',
...
// 한국판 AI 윤리기준
'# 정의 : 인간성 위한 인공지닁 구현 / 과학기술정보통신부 제안 / 인공지능 윤리기준 <br/>\
...
- 사회의 공공선 원칙 <br/><br/>\
# 10가지 핵심조건 <br/>\
- 인권보장 : 인간중심, 인간의 권리와 자유 보장, 사람중심 서비스 <br/>\
- 프라이버시 보호 : 사생활 보호, 개인정보 오용 최소화 <br/>\
- 다양성 존중 : 다양성, 접근성 보장, 비차별성, 편향, 차별 최소화 <br/>\
- 침해금지 : 인간 무해한 목적으로 활용 <br/>\
- 공공성 : 공공성 증진, 인류의 공동 이익 목적, 순기능 극대화, 교육 <br/>\
- 연대성 : 집단간 연대성, 이핸관계자 참여 기회 보장, 국제사회 협력 <br/>\
- 데이터 관리 : 목적 외 용도 활용 금지, 데이터 편향 최소화, 품질, 위험관리 <br/>\
- 책임성 : 책임의 명확화, 주체별 책임 <br/>\
- 안전성 : 잠재적 위험 방지, 안전 보장 <br/>\
- 투명성 : 설명 가능성, 활용 내용 및 유의사항 사전 교체 <br/><br/>\
* ITPE 6회 관리 1교시 12번\
',  
