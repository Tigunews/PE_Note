...
# 개선 방안 <br/>\
- 전통적인 기술 보완 : 인공지능이 할 수 없는 부분 규칙 기반 기술 적용 <br/>\
- 인공지능 근거 설명 : 별도 알고리즘 통한 설명 <br/>\
- 혼합 알고리즘 구성 : 인공지능, 알고리즘 혼합 구성 방식 <br/><br/>\
* KPC 93회 1교시 11번 <br/>\
* KPC 94회 4교시 4번 \
',
...
# 한국어 처리 난해성 <br/>\
- 교착어 : 어근 + 접사 형태 / 잡다(일반), 잡히다(피동), 잡았다(과거) <br/>\
- 띄어쓰기 : 표준 지속적 변경 / 농협용 인육 가공, 농협 용인 육가공 <br/>\
- 평서문, 의문문 : 같은 형태 구조 / 점심 먹었어(. ?) <br/>\
- 주어 생략 : 동사 중요시, 문맥 정보 활용 파악 / (점심) 먹었어 <br/>\
- 한자 기반 언어 : 표어문자 + 표음몬자 정보 손실 발생 / 모을집 + 가운데중 = 집중 <br/><br/>\
* ITPE 9회 관리 3교시 2번 <br/>\
* 123회 관리 4교시 4번\
',
