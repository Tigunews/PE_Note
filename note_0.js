...
var memorization =
[
'', '정성적 위험분석', '정량적 위험분석', '암스트롱 공리', 'Join', '뉴딜', 'ITIL', 'IEEE 802.11p', '데이터 댐', 'ISO/IEC 27018', 'Cloud 보안', 'IEEE/ISO/IEC 25010', '4 Plus 1 View', '패키지 설계', 'ISO/IEC 20889', '이상값', 'major state', '33000', '25000', '커널 메모리 할당', 'IPv6', 'DHCP', '멀티 클라우드', '쿠버네티스', '12 Factors', 'Smart Grid', 'CMMI', 'SD WAN', '멀티 클라우드', '산업의 디지털 전환 및 지능화 촉진법',
]
