...
- 근거 : SW 진흥법 제 57조, 동법 시행령 제 66조 제 1항 제 15호 <br/><br/>\
# 로드맵 <br/>\
<img src = "./img/SW_2021.png" style = "max-width:100%; height:auto;"><br/><br/>\
# SW 진흥법 소관 항목 <br/>\
1. 과업심의 위원회 <br/>\
- 법적근거 : 제 50조 <br/>\
- 내용 : (과업내용변경) 제안요청서 등에 법 50조에 따른 과업 변경 요청 가능 명시 여부 <br/><br/>\
2. 상용 SW 직접구매 및 SW품질 성능 평가시험(BMT) <br/>\
- 법적근거 : 제 51조 <br/>\
- 기준 : 총 사업규모 3억 상용SW, 조달청 등록제품 5천만원 이상 <br/>\
- 내용 : 직접 구매 대상 상용 SW 경쟁 입찰 구매 경우 BMT 실시 <br/><br/>\
3. 중소 SW 사업자의 사업 참여지원 <br/>\
- 법적근거 : 제 48조 <br/>\
- 내용 : 사업금액에 따른 대기업참여하한 적용 및 입찰참가자격 명시여부 <br/><br/>\
4. 하도급 제한 <br/>\
- 법적근거 : 제 51조 <br/>\
- 내용 : 50% 제한, 재하도급 금지, 사전승인 <br/><br/>\
5. SW 사업 작업장소(원격 개발) <br/>\
- 법적근거 : 제 49조 3항 <br/>\
- 내용 : SW 사업수행 위한 작업장소 협의 결정 명시 여부 <br/><br/>\
6. SW 사업 산출물 활용 보장 <br/>\
- 법적근거 : 제 59조 <br/>\
- 내용 : 지식재산권 공동소유 원칙 명시 여부 <br/><br/>\
7. 하자담보 책임기간 및 범위 <br/>\
- 법적근거 : 제 60조 <br/>\
- 내용 : 검수 후 최종산출물 인도한 날부터 1년 이내 하자담보책임기간 명시 여부 <br/><br/>\
8. 협상에 의한 계약방식 적용 <br/>\
- 법적근거 : 제 49조 제 1항 <br/>\
- 내용 : SW 사업에 대한 협상에 의한 계약 체결 방식 채택여부 <br/><br/>\
9. SW 기술성 평가기준 적용 <br/>\
- 법적근거 : 제 49조 제 2항 <br/>\
- 내용 : 기술능력평가 시 평가기준을 SW 기술성 평가기준 적용/활용 여부 <br/><br/>\
10. SW 사업제안서 보상 <br/>\
- 법적근거: 제 52조 <br/>\
- 내용 : 20억원 이상의 SW 개발 사업에서 제안서 보상에 대한 명시 여부 <br/><br/>\
11. 요구사항 상세화 <br/>\
- 법적근거 : 제 44조 <br/>\
- 내용 : SW 사업의 상세 요구사항 작성표 사용여부 <br/><br/>\
12. SW 사업 적정 상버기간 산정 <br/>\
- 법적근거 : 제 45조 <br/>\
- 내용 : SW 개발과 관련된 사업, 적정사업기간 산정기준 따른 사업 명시 및 종합 산정서 첨부 여부 <br/><br/>\
13. 투입인력 요구 및 관리 금지 <br/>\
- 법적근거 : 관리감독 지침 11-3, 18-3 <br/>\
- 내용 : SW 개발과 관련된 사업의 경우 제안요청서 내 투입인력 관련 사항 명시 불가능 <br/><br/>\
14. SW 사업 영향평가 <br/>\
- 법적근거 : 제 43조 <br/>\
- 내용 : SW 사업 영향평가 검토 결과서 첨부 여부 <br/><br/>\
15. SW 사업 정보 제출 <br/>\
- 법적근거 : 제 46조 <br/>\
- 내용 : SW 개발/재개발/유지보수 및 운영 관련 사업 경우 제안요청서 내 SW 사업정보 제출 명시 여부 <br/><br/>\
# 타법 소관 항목 <br/>\
1. 개발 SW의 공동활용 사전 명시 <br/>\
- 법적근거 : 국유재산법 제 65조의 12 <br/>\
- 내용 : 개발 SW가 타 기관에 공동활용 되는지 사전 안내, 공동활용 시 타 기관 명시 여부 <br/><br/>\
2. 특정규격 명시 금지 <br/>\
- 법적근거 : 정부입찰/계약 집행기준 5-4-5 <br/>\
- 내용 : 특정상표 또는 모델/규격 등 명시 여부 <br/><br/>\
3. 기술능력평가비중(90%) 도입 <br/>\
- 법적근거 : 협상에의한 계약체결기준 제 7조 <br/>\
- 내용 : 협상방식 적용사업에서 기술능력 대 가격점수 비중 90:10 제시 여부 <br/><br/>\
* 라이지움 91회 관리 3교시 4번\
',
...
// 디지털서비스 전문계약제도
'# 개념 : 공공 디지털 이용 촉진, 산업 성장 / 디지털 정부 혁신 제도 <br/>\
- 과기부장관이 공공기관이 민간클라우드 컴퓨팅 도입 및 이용을 활성화하기 위해 디지털 서비스에 대해 사전 심사를 선정 및 이용을 촉진하는 제도  <br/><br/>\
# Keyword : 클라우드컴퓨팅법, 국가계약법 시행령, 조달사업법 시행령, 클라우드컴퓨팅서비스, 융합서비스 <br/><br/>\
# 개정안 주요내용 (<font color = "red">수정심카</font>)<br/>\
- 수의 계약 허용 : 심사위원회에서 사전 선정 디지털서비스 대해 체결 허용 <br/>\
- 정의 신설(클발법) : 서비스, 지원서비스, 융합서비스 <br/>\
...
# 디지털 서비스 유형 <br/>\
- 서비스 : 클라우드 활용 타인에게 정보통신자원 제공 <br/>\
- 지원 서비스 : 매니지드(컨설팅(분석,수립), 운영관리(모니터링,장애처리,백업), 마이그레이션(운영환경전환)) <br/>\
- 융합 서비스 : 다른 기술 서비스와 융합(가상화, 분산처리, 배치관리 자동화) <br/><br/>\
...
// 분산 클라우드
'# 정의 : 퍼블릭 클라우드 / 다른 물리 위치 배포 / 운영, 거버넌스, 업데이트, 제공업체 책임 <br/>\
