...
- 물리적 Data는 자사에, 기술력은 벤더사에 (분산 클라우드가 프라이빗 클라우드 대체) <br/>\
- 다양한 물리적 위치에 퍼블릭 클라우드 서비스 배포하며, 운영 및 거버넌스는 클라우드 공급 업체 책임 구조 <br/>\
- 클라우드 컴퓨팅 서비스의 강점을 대부분 유지 하면서, 지역적으로 더 많은 곳에서 고객이 위치한 최대한 가까운 곳에서 서비스 할 수 있도록 분산시킨 클라우드 <br/><br/>\
# 유형 <br/>\
