...
// [AI]- XAI
'# 정의 : AI 의사 결정 결과 설명 기술<br/>\
- 주어진 데이터에 대해 분류/예측 뿐 아니라 인과관계를 분석하여 적절한 근거를 찾고, 융/복합적 기술 개발을 통해 AI 모델 의사결정 결과를 사용자 레벨에서 설명하는 AI 기술(모델) <br/><br/>\
# 특징 <br/>\
- 인공지능 블랙박스 문제 대응 <br/>\
- 사용자 정보 활용 근거 제공 <br/>\
- 적용 영역 확대 기반 <br/><br/>\
# 동향 <br/>\
- EU : 설명제공 강제 <br/>\
- 미국: DARPA(미국 방위고등연구계획국) 주도 <br/>\
- 한국 : XAI 연구센터 설립 <br/><br/>\
# 구현기법 <br/>\
1. DARPAR 프레임워크 기반 <br/>\
- 설명가능 모델 <br/>\
1) 심층설명학습 : 심층신경망 설명 가능한 특징 학습 / 딥러닝 변형 <br/>\
2) And Or Graph : 객체 특성 표현 / 인과관계 시각화 <br/>\
- 근거설명 인터페이스 <br/>\
1) 설명가능IF : 설명 이해, 필요한 내용 포함 / 사용자 기준 평가 <br/>\
2) 정정가능IF : 피드백 존중, 점진적 변화 주시 / 정정에 따른 개선 <br/><br/>\
2. Model-Agnostic 측면 구현 기법 <br/>\
- LIME <br/>\
1) Local Interpertable Model agostic <br/>\
2) 모델 희소선형결합 국부적 설명 <br/>\
- BRL <br/>\
1) Bayesian Rule List <br/>\
2) 모델을 일련의 if-then 조건문 으로 표현 <br/><br/>\
3. 시각화 측면 구현 기법 <br/>\
- LRP<br/>\
1) Layer-wise Relevance Propagation <br/>\
2) 결과로부터 역전파 형태로 계층 기여도 측정 <br/>\
- 자동 통계학자 <br/>\
1) 데이터 분석부터 사람이 이해할 수 있는 보고서 제공하는 과정까지 자동화 하는 것을 목표 <br/>\
2) 시계열 데이터, 가우시안 프로세스 분석 <br/><br/>\
# 설명가능 인공지능 사용성 평가 방법 <br/>\
<img src = "./img/XAI_1.png" style = "max-width: 100%; height: auto;"><br/><br/>\
1. 최종 설명 산출물 <br/>\
- 설명 내용 : 상세 문법, 인과관계 설명 적합성 여부 평가 <br/>\
- 설명 근거 : 문장 연계 및 관련 근거 제공 문장 평가 <br/>\
- 제공 환경 : 사용자 환경에 따른 커스터마이징 여부 <br/>\
- 제공 품질 : 다른 환경 내 동일 기준 적용 및 근거 제공 확인 <br/><br/>\
2. Mental Model <br/>\
- 개정 문구 : 불특정 다수에게 적용시 이해 가능 여부 판단 <br/>\
- 재사용 여부 : 타 모델 산출물과 혼합 사용 및 일관성 평가 <br/><br/>\
3. 시스템 작업 대상 <br/>\
- 모델 규모 : 적용 AI 모델 복잡도에 따른 산출물 생성 시간 측정 <br/>\
- 모델 연계 : 타 시스템 내 동일 환경 수행 시간 측정 <br/><br/>\
# 이해관계자 관계도 <br/>\
<img src = "./img/XAI_2.png" style = "max-width: 100%; height: auto;"><br/><br/>\
* KPC 94회 4교시 4번 \
',
...
- 특징기반 : Q&A, 상황정보 <br/><br/>\
# 문제점 <br/>\
- 개인정보 유출 인한 프라이버시 문제 및 이용 거부감 <br/>\
- 기기간 호환성을 위한 표준화 미흡 <br/>\
- 생체정보 복원 및 해킹 등 보안 문제 <br/>\
- 기기 오류율 문제 <br/>\
- 단말기 배포 및 고가의 센서 등 높은 운영 비용 <br/>\
- 법률 문제 <br/><br/>\
# 대응 <br/>\
- 정부 : 금융기관의 자율적 경쟁체계 조성, 생체정보 보호 프로세스 구축, 이해관계 조율 <br/>\
- 민간 : 기술고도화 노력 지속, 상호 협력체계 구축 <br/>\
- 중앙은행 : 표준화 추진 <br/><br/>\
<img src = "./img/비대면인증기술_1.png" style = "max-width:100%; hegiht:auto;"><br/><br/>\
<img src = "./img/비대면인증기술_2.png" style = "max-width:100%; hegiht:auto;"><br/><br/>\
<img src = "./img/비대면인증기술_3.png" style = "max-width:100%; hegiht:auto;">\
',
...
- 국가정보화 기본법 32조 5항 <br/>\
- 국가표준2.0 : 인운이견 <br/>\
- 인 : 대.색.명.자, 명확(하게) 지시(해서). 알림 <br/>\
- 운 : 초.누.응.정.컨 <br/>\
- 이 : 입.인.깜.자.예 <br/>\
- 견 : 폰.보호 <br/><br/>\
- kwcag 2.0 <br/><br/>\
# 근거 : 국가정보화 기본법 32조 5항 <br/><br/>\
# 적용범위 : 국가기관, 지방자치단체 및 공공기관등이 모바일 어플리케이션 구축/운영, 개선, 유지보수할 경우 적용 <br/><br/>\
# 적용기기 : 운영체제를 갖는 모바일 전화기/테블릿/전자책 <br/><br/>\
# 모바일 앱 접근성 국가 표준 2.0 <br/>\
- 인식용이성 : 대체 텍스트, 색 무관 인식, 명도대비, 자막/수화, 명확한 지시사항, 알림기능 <br/>\
- 운용용이성 : 초점, 누르기, 응답시간 조절, 정지기능, 컨트롤 크기와 간격 <br/>\
- 이해용이성 : 입력도움창, 사용인터페이스의 일관성, 깜빡거림 사용제한, 자동재생금지 예측 가능성 <br/>\
- 견고성 : 폰트 관련 기능 활용, 보조기술과의 호환성 <br/><br/>\
# 인증기관 : 한국웹접근성인증평가원 kwcag 2.0 <br/>\
- 기술성 심사와 장애인 당사자가 직접 기기를 사용하여 사용성을 심사하여 90점 이상, 사용자는 모바일 애플리케이션 접근성 지침에 의한 90% 이상 준수 <br/>\
- 부적합 판정시 7일간 수정후 재평가 <br/><br/>\
# 심사기준 <br/>\
- 모바일 웹 : 전문가는 한국형 웹 컨텐츠 접근성(KWCAG 2.0)에 의한 95% 이상, 사용자는 모바일 애플리케이션 접근성 지침에 의한 90% 이상 준수 <br/>\
- 안드로이드 : 모바일 애플리케이션 접근성 지침에 의한 90% 이상 준수 <br/>\
- IOS : 모바일 애플리케이션 접근성 지침에 의한 90% 이상 준수\
',
