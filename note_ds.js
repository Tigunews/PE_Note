...
# 기술 동향 <br/>\
1. 에너지 측면 <br/>\
- 에너지 하베스팅 : 초 전력 마이크로 컨트롤러(MSP 430), CMU에서 보드 하드웨어 설계도 공개 <br/>\
- 에너지 저악 시루 : 동적 재구성 가능 장치(CMU, HW SW 동시설계), 부품별 ESS 연결(부품간 에너지 간섭 제거) <br/><br/>\
2. 데이터 측면 <br/>\
- 비 휘발성 메모리 변환 : 메모리 시스템 교체, 특성 결합(캐시 계층, 비 휘발성 특성 혼합 복합 메모리 계층 연구) <br/><br/>\
- 실행 모델 및 프로그래밍 언어 : App 제어(다중 버전 모델, 체크포인팅 프로세스), 안전성 보장 프로그래밍 (CMU-Chain(Overhead x),Alpaca(Task 기반 데이터 공유)) <br/><br/>\
* KPC 91회 응용 3교시 7번\
', 
...
- 다중경험 -> 전체경험 <br/>\
- 새로운 비즈니스 결과물을 도출하기 위해 다양한 참여자들의 경험을 개선하려는 기술 <br/><br/>\
# 등장 배경 <br/>\
- 기술 : 다중경험 고도화 <br/>\
...
- 클저지연, 데이터 비용 절감, 데이터 레지던시를 필요로 하는 기업들에게 매우 민첩한 데이터 환경을 제공하는 기술 <br/><br/>\
# 기대효과 <br/>\
...
- 모든 장소에서 고객 지원, 근무 지원, 그리고 분산된 인프라 전반에 걸친 사업활동 등을 지원하는 IT 운영모델 <br/><br/>\
# 핵심 가치 <br/>\
- Digital First <br/>\
- Remote First <br/><br/>\
# 사례 <br/>\
...
- 자산 또는 개인이 어디에 있든 모든 디지털 자산에 안전하게 접근할 수 있도록 해주는 기술 <br/><br/>\
# 등장배경 <br/>\
...
// AI 엔지니어링
'# 정의 : 다양한 AI 및 기계학습 또는 지식 그래프와 같은 의사결정 모델의 거버넌스와 생애주기 관리에 대한 학문분야  <br/><br/>\
# 동향 <br/>\
...
- 기업들이 신속하게 최대한 많이 승인된 사업 및 IT 프로세스 식별, 검증, 그리고 자동화 접근법 뜻함 <br/>\
