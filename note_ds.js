...
# 민간 클라우드 / PPP 클라우드(임대) / Private 클라우드 <br/>\
- 자산소유 : 클라우스 사업자 / 클라우드 서비스 사업자 / 이용기관 <br/>\
- 예산집행계정 : 제세 및 공과금, 정보화 예산 // 정보화 예산 <br/>\
- 구축주체 : 클라우드 서비스 사업자 // 이용기관(중견, 중소SI) <br/>\
- 운영주체 : 클라우드 서비스 사업자 // 이용기관(유지보수업체) <br/>\
- 품질관리주체(SLA) : 클라우드 서비스 사업자(SLA기준 충족) // 이용기관 <br/>\
- 보안통제주체 : 클라우드 서비스 사업자 / 이용기관 // \
',

// G-Cloud
'# 정의 : 정부통합전산센터 클라우드 / 스마트 전자정부 / 행정기관 IT 수요 / 통합, 구축, 활용, 제공 / 클리우드 기술 <br/>\
- 정부통합전산센터 클라우드의 고유명칭으로 스마트 전자정부 서비스를 위해 행정기관의 IT 자원 수요를 모아 정보자원을 통합해 일괄 구축한 뒤, 공동 활용하고, 필요한 만큼 신속하게 제공하는 기술 및 서비스\
',
