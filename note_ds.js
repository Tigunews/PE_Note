...
# 클라우드 플래그십 프로젝트 <br/>\
- 금융 : 기존 시스템 클라우드 전환, 비대면 금융거래 활용 서비스 / 인프라, 서비스 개발<br/>\
- 제조 : 전자의 데이터 AI 기반 생산공정(설계->계획->가공->검수) 서비스 / 인프라, 서비스 개발 <br/>\
- 물류 : 항만 연계 물류 사업, 무인 자동화, 재난 예방 지능형 클라우드 / 인프라, 서비스 개발 <br/>\
- 에너지 : 건물 설비 에너지 사용 분석,진단,예측,제어 클라우드 / 인프라, 서비스 개발 <br/><br/>\
# 후속 조치 사항 <br/>\
- 데이터 표준화 및 품질 관리 <br/>\
- 디지털 전문계약 제도 도입 <br/>\
- AI 법제/윤리 기반 마련 <br/><br/>\
