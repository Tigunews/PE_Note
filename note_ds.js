...
- 의사결정 방식을 근본적 재설계 구성 가능한 비즈니스 형태<br/><br/>\
# 속성 <br/>\
- Modularity <br/>\
- Autonomy <br/>\
- Orchestration <br/>\
...
// AI 엔지니어링
'# 정의 : 머신러닝이나 지식 그래프 등 AI 및 결정 모델의 거버넌스와 라이프사이클을 관리하는데 초점이 맞춰진 엔지니어링 형태  <br/><br/>\
# 동향 <br/>\
- Need : AI 시제품에서 생산 단계 까지 가는 프로젝트 비율 53% 불과 <br/>\
...
// 공공데이터 품질관리 매뉴얼 V2.0
'# 총론 : 공공데이터 품질관리 매뉴얼 개발의 배경과 목적, 매뉴얼의 구성 체계 및 활용방안을 제시하고, 공공기관 실무자 중심의 데이터 품질관리에 대한 개념을 설명 <br/><br/>\
# 품질관리 활동 <br/>\
