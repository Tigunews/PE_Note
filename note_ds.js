...
// 데이터 주권 이슈
'# 이슈 <br/>\
- 데이터 이동 : 국경간 데이터 이동, 조세 형평성, 데이터 민족주의(Nationalism) <br/>\
- 디지털세 : 디지털 비즈니스 모델 적용, 디지털 사업장 개념 추가 <br/>\
- 데이터 관련 무역 규범의 조문화 : 국경간 데이터 이동 보장, 설비 지역화,소스 공개 요구금지<br/>\
- 중국 미국 대결 구도 : 하웨이 사태, 데이터 주권 양상 <br/>\
- 글로벌 데이터 기업 규제 : 글로벌 데이터 기업 시정조치, 과징금 <br/><br/>\
* 124회 관리 2교시 1번\
',
...
- 로봇이 미지의 환경을 돌아다니면서 로벗에 부착되어 있는 센서만으로 외부의 도움 없이 환경에 대한 정확한 지도를 작성하는 작업 <br/><br/>\
# 주요 기술 <br/>\
1. 센서 <br/>\
