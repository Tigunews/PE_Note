...
'[운영유지보수단계]- 레만의 원리',
'[운영유지보수단계]- Code Smell',
'[운영유지보수단계]- Refactoring',
'[운영유지보수단계]- 3R',
'[운영유지보수단계][3R]- 역공학(저작권 측면)',
'[운영유지보수단계]- Anti-Reversing',
'[운영유지보수단계][Anti-Reversing]- 코드가상화',
...
'[관리표준]-ISO 21500',
'[관리표준][ISO 21500]- ISO 15504(SPICE)',
'[관리표준]- SWEBOK',
'[관리표준]- 요르돈법칙',
'[품질표준]- SW 품질',
'[품질표준]- SW 품질관리',
...
'[품질표준][제품품질]- NEP 인증',
'[품질표준][제품품질]- NET 인증',
'[품질표준][제품품질]- 공개SW컴플라이언스 이슈',
'[품질표준][라이선스]- 오픈소스 라이선스',
'[품질표준][라이선스]- 오픈소스 라이선스 분류',
'[품질표준][라이선스][오픈소스 라이선스]- GPL',
'[품질표준][라이선스][오픈소스 라이선스]- LGPL',
'[품질표준][라이선스][오픈소스 라이선스]- BSD',
'[품질표준][라이선스][오픈소스 라이선스]- Apache',
'[품질표준][라이선스][오픈소스 라이선스]- MPL',
...
1. 데이터 기능 <br/>\
- 기능유형 : ILF, EIF <br/>\
- 복잡도 및 기여도 : DET, RET <br/>\
2. 트랜잭션 기능 <br/>\
- 기능유형 : EI, EO, EQ <br/>\
- 복잡도 및 기여도 : DET, FTR <br/><br/>\
# 절차(IFPUG) <br/>\
1. 유형결정 : 개발 PJT, 개선 PJT, 어플리케이션 <br/>\
2. 측정범위와 경계 식별 <br/>\
3. 데이터 기능 측정 <br/>\
4. 트랜잭션 기능 측정 <br/>\
5. 미조정 기능 점수(UFP) = 3 + 4 <br/>\
6. 보정계수 인자 결정 : VAF = 규언유품 등 14개 인자 1~5점 * 0.01 + 0.65 <br/>\
7. 조정 기능 점수 결정 : AFP = UFP * VAF = 개발비 <br/>\
8. 직접경비, 이윤(개발비 25%) <= 재경비, 기술료 없음, 복잡도에 포함 <br/>\
- 간이법 : DET, RET, FTR 산정 대신 평균 복잡도 적용 <br/>\
- 정규법 : DET, RET, FTR 적용<br/><br/>\
# 기능점수 검증 <br/>\
- 국내 평균생산성과 비교분석 : SW공학백서 12년 기준 국내 평균생산성 (23.4 FP/MM)와 비교 <br/>\
- 기능별 평균비율과 비교분석 : EI, EO, EQ, ILF, EIF각 기능별 비율조사 Data기준 <br/>\
- 단위 프로세스별 오류검증 <br/>\
- SW사업 저장소 데이터 활용 <br/><br/>\
# <2016 대가 산정 가이드> 단위 프로세스 식별 권고 사례(의쿠X) <br/>\
- 데이터 적재, 업로드 설정 : EI(ILF 변경하므로) <br/>\
- 그래프, 통계 : EO (가공된 데이터, 제어정보 제공) <br/>\
- 발송, 다운로드 로그인, 사용자인증 : EQ (ILF, EIF로 부터 데이터, 제어정보 가공(수학계산, 파생데이터, ILF유지, 시스템 상태변경) 없이 제공 <br/>\
- 전송 : EQ, EO <br/>\
- 로그아웃, 코드데이터, 임시파일, 이력정보, 첨부(단위프로세스 완료하지 못하므로), 로그, 단순파일변환(hwp->pdf) : 제외(ILF)아님 <br/><br/>\
# 측정시 유의사항 <br/>\
- 사용자의 논리적 관점에서 사용자에게 가치있는 기능 식별 <br/>\
- SW가 사용자에게 제공하는 기능적 요구사항 측정 <br/>\
- 수요자관점 측정 : SW가 어떻게 구현되었는지 공급자 관점x , 사용자가 어떤 기능 요구했는지의 수요자 관점 <br/>\
- 개발에 필요한 노력(투입공스) 기반 식별 x <br/><br/>\
...
// 아키텍처 드라이버 
'# 정의 : 큰 영향 요구사항 <br/>\
- SW 아키텍처 구성에 큰 영향을 주거나 시스템 전체의 구성 또는 성능/품질에 영향을 주는 요구사항 <br/><br/>\
# 구성 <br/>\
- 기능요구 <br/>\
- 품질요구 <br/>\
- 제약사항 <br/><br/>\
...
# 복잡도V(g) = e - n + 2 = 폐쇄구간수(region) = 단순분기 + 1<br/>\
- 단순 : V(g) <= 5 <br/>\
...
// Python
'# 정의 : 1989년 암스텔담의 괴도 반 로섬(Guido van Rossum) 이 개발한 인터프리터 언어 (TTA) <br/><br/>\
# 장점 <br/>\
1. 인터프리터 언어 <br/>\
- 프로그래밍 언어의 소스코드를 바로 실행 가능 <br/>\
- 컴파일, 실행, 에러의 수정이 아닌 즉시 테스트 가능 <br/><br/>\
2. 플랫폼 독립적 <br/>\
- 리눅스, 유닉스, 윈도우, 도스 등 대부분의 운영체제에서 플랫폼과 상관없이 사용 가능 <br/><br/>\
3. 간결한 코드 <br/>\
- 간단한 문법과 정리가 잘된 구문<br/>\
- 프로그래머, 일반인이 접근하기 쉽고 사용하기 용이 <br/><br/>\
4. 오픈소스 및 흡수성 <br/>\
- 무료로 사용 가능 <br/>\
- 기존 개발자가 개발한 수 많은 모듈의 사용 가능 <br/>\
- 다른 언어로 제작된 모듈들도 포함해서 사용 가능 <br/><br/>\
5. 동적 타입 언어 <br/>\
- 런타임에 구문을 통해 Data Type 설정 <br/>\
- 실행하는 시점에서 변수의 타입을 고려하기 떄문에 타입에 자유롭게 개발이 가능 <br/><br/>\
6. 멀티 패러다임 <br/>\
- 절차지향, 객체지향, 함수형, 관점형 프로그램 모두 사용 가능 <br/><br/>\
7. 무제한 접근 <br/>\
- 사용의 단순함, 편리함을 위해 접근제어 없이 객체, 구조체 멤버에 무제한 접근 가능 <br/><br/>\
8. 메모리 자동관리 <br/>\
- Garbage Collector <br/><br/>\
# 단점 <br/>\
1. 느린 속도 <br/>\
- Script 언어로서 코드 동작시에 컴파일된 실행파일이 아닌 코드를 직접 하나씩 해석해서 실행하는 시간이 소요 <br/><br/>\
2. 모바일 컴퓨팅과 브라우저의 부재 <br/>\
- 모바일 컴퓨팅 취약하여 앱 어플리케이션의 클라이언트 측면에서도 거의 미 존재 <br/>\
- 보안상의 어려움 및 SandBox등의 미존재로 인한 브라우저 개발의 제약 <br/><br/>\
3. 설계 제약 <br/>\
- 동적입력으로 인한 더 많은 테스트가 필요 <br/>\
- 실행시간에 발생하는 오류의 존재로 인해 설계의 한계점이 존재 <br/><br/>\
# Python Data type <br/>\
1. Numeric <br/>\
- int : 일반 정수 형태 <br/>\
- float : 유효숫자를 나타내는 가수와 소수점의 위치를 풀이하는 지수로 이루어진 자료형 <br/>\
- complex : 실수와 허수부를 구분하여 표현 ( -7 + 2j ) <br/><br/>\
2. String <br/>\
- str : ", \' 사용 가능 <br/><br/>\
3. Boolean <br/>\
- bool : True, False <br/><br/>\
4. List <br/>\
- 여러가지 Object로 이루어진 데이터 집합 <br/>\
- 값을 나열하여 표현하며 인덱스를 사용하여 참조 가능 <br/>\
- [1, 2, 3, [\'a\', \'b\']] <br/><br/>\
5. Tuple <br/>\
- 불변한 순서가 존재하는 Object 집합 <br/>\
- List와 비슷하지만 한번 생성되면 값을 변경 불가 <br/>\
- (1,2,3), (\'a\', \'b\', (\'a\', \'b\'))<br/><br/>\
6. Dictionary <br/>\
- Key, Value 한쌍 매핑, 순서가 없는 집합 <br/>\
- 순차적인 요소 값이 아닌 키를 통한 값을 얻음 <br/>\
- {\'name\' : \'Hong\', \'Phone\', : 010) <br/><br/>\
7. Set <br/>\
- 중복과 순서가 없는 수학의 집합과 동일한 자료형 <br/>\
- 집합안에서는 유일한 값을 가짐 <br/>\
- set("Hello") <br/><br/>\
# Python 자료형 확인 및 검사 방법 <br/>\
1. 자료형 확인 <br/>\
a = \'a\' <br/>\
print(type(a)) <br/><br/>\
Result : &#60class \'str\'&#62<br/><br/>\
2. 자료형 검사 <br/>\
a = \'a\' <br/>\
if(str(type(a) == &#60class \'str\'&#62"); <br/>\
　print("String") <br/><br/>\
Result : String <br/><br/>\
* 대표적인 3세대 객체 지항형 스크립트 언어 : Ruby, Perl, Python <br/><br/>\
* 122회 2교시 1번\
',
...
- 테스트 일반 <br/>\
1) 결함발견활동 <br/>\
2) 불완전 :Tmmi, TPI등 인증 활용 <br/>\
- 계획 <br/>\
3) 개발초기에 시작 <br/>\
4) 결함집중(MC/DC) <br/>\
- 검증/개발 <br/>\
5) 살충제 패러독스 : 테스트 케이스 자동화 도구 이용 <br/>\
6) 정황에 의존적 : 경험기반 테스트 활용 <br/>\
- 검증 <br/>\
...
2. 목적 <br/>\
- 단위성능 <br/>\
- 복합성능 : 사용자 사용패턴 맞춰 동시사용자 및 가중치 적용 테스트 <br/>\
- 임계성능 : 임계도달 <br/>\
- 확장성 : 증설전후 성능 \
',
...
- 직접 조사발견<br/>\
- Review : 검사자들이 직접<br/>\
<img src = "./img/ReviewType.jpg" style = "max-width:100%; hegiht:auto;"><br/><br/>\
2. 자동 <br/>\
- 오류 패턴 검사, 발견 <br/>\
- 자동화된 테스트 도구 <br/>\
1) 문법결함(Syntax) : ex) 모든 지역 변수는 사용전에 값 할당이 이루어져야 한다<br/>\
2) 의미결함(Semantic) : 실행 의미적 검사 / 프로그램 경로, 경로 도메인<br/><br/>\
# 장단점 <br/>\
1. 장점 <br/>\
- 빠르다 <br/>\
- 수행노력 적음 <br/><br/>\
...
- 기능 동작 검증 불가능 <br/><br/>\
# 정적테스트 이슈 <br/>\
- 오류 유형에 알맞은 수행방식 선정 <br/>\
- 테스트 종료 기준 필요 (요구품질 기준)<br/><br/>\
# 활용 <br/>\
- 테스트 방법 선정 <br/>\
- 명세/코드 <br/>\
- 검사 패턴 규정 <br/><br/>\
# 자동화 도구 <br/>\
- Code Inspector : C/C++/Java 코드에 잠재적인 구문결함 분석 <br/>\
- Find Bugs : Java 코드에 대한 잠재적인 의미결함 분석 <br/>\
- CPP Check : C/C++ 코드에 대한 잠재적인 구문 결함 분석 <br/>\
- Source Monitor : C/C++ 코드에 대한 메트릭 분석 \
',
...
- 시스템 단위 시험 <br/><br/>\
# 장단점 <br/>\
- 장점 : 기능동작 정밀검증, False 알람 빈도 낮음 <br/>\
- 단점 : 노력, 시간이 많이 필요 <br/><br/>\
# 동적테스트 이슈 <br/>\
1. 테스트 케이스 설계 <br/>\
- 동등클래스 분할 <br/>\
- 경계값 분석 <br/>\
...
3) 명세 <br/>\
- 정의 : 테스트커버리지 기준 <br/><br/>\
1) 단위 테스트 : 구문, 조건, 결정, 변경 조건/결정 <br/>\
2) 통합 테스트 : 함수(호출), 함수 콜(호출 지점) <br/>\
3) 시스템 테스트 : 명세 커버리지(요구 명세 수행정도) <br/><br/>\
# 동적 테스트 활용 <br/>\
- 테스트 케이스 <br/>\
- 테스트 결과 기준 <br/>\
- 명세/코드 <br/>\
...
- 테스트 결과 <br/><br/>\
# 동적 테스트 도구 <br/>\
- Controller Tester : C/C++ 프로그램에 대한 함수 단위 및 함수 통합 동적 테스트 <br/>\
- Test Monitor : C/C++/Java 프로그램에 대한 시스템 기능 테스트 코드 커버리지 측정 <br/>\
- AVA : 프로그램의 시스템 기능 테스트 케이스 자동 생성 및 자원 사용량 측정 <br/>\
- AMOS : 프로그램의 시스템 자원 사용량 측정 및 메모리 누수 추적 <br/>\
- Soap UI : Http, Soap, REST 방식의 구현한 웹서비스의 기능성 및 성능 테스트 <br/>\
- J Meter : 웹서비스 부하 테스트 (HTTP, FTP, LDAP 지원) <br/><br/>\
* 라이지움 86회 2교시 4번',
...
'# 정의 : 모든 입력값 조합 페어 테스트 <br/>\
- 모든 가능한 입력값들의 조합들을 테스트하는 대신 모든 짝(Pair)들의 조합을 테스트하는 방법 <br/>\
- IPO(In-Parameter-Order) 알고리즘을 이용하여 테스트케이스 도출 가능 <br/><br/>\
# 절차 <br/>\
1. 처음 두 입력변수의 모든 쌍을 구함 : (Window, Firefox), (Window, IE), (Linux, Firefox), (Linux, IE) <br/>\
2. 그 외의 모든 입력변수의 쌍의 집합을 구하고, 이를 AP라고 한다. <br/>\
-> AP = {(Window, LAN), (Window, PPP), (Linux, LAN), (Linux, PPP), (Firefox, LAN), (Firefox, PPP), (IE, LAN), (IE, PPP)} <br/>\
3. 처음 두 입력변수의 쌍에 그 다음 입력변수를 하나씩 리스트 하고, 포함된 쌍을 AP에서 삭제함 <br/>\
4. AP 에서 가장 많은 짝을 제거할 수 있는 값을 할당한다. 모든 짝이 AP에서 삭제될 때까지 반복한다.\
',
...
// 품질관리QC7도구
'# 정의 : 데이터긔 기초적인 정리 방법 <br/>\
- 적은 데이터로부터 가능한 한 신뢰성이 높은 정보를 얻는데 가장 유효한 수단으로서 품질의 개발, 개선, 관리의 제 활동에 대한 유용한 도구로, 데이터의 기초적인 정리방법으로 널리 쓰이며, 품질관리를 하는데 있어서 가장 필수적인 통계적 방법 <br/><br/>\
# 구성 <br/>\
- 인과관계도 : 특성요인도-원인규명 <br/>\
- 흐름도 : Flow Chart <br/>\
- 체크시트 <br/>\
- 파레토 다이어그램 : 시정조치 우선순위 <br/>\
- 히스토그램 : Data 분포 <br/>\
- 관리도 : Control charts <br/>\
- 산점도 <br/>\
- 층별 : 품질 영향 끼치는 원인분석\
',
...
1. 위험 관리 계획 수립 <br/>\
- 개념 : 위험 관리 기준, 활동에 대해 정의하고 계획 <br/>\
- 산출물 : 위험 관리 계획서 <br/><br/>\
2. 위험 식별 <br/>\
- 개념 : 성공 영향 위험 식별, 그 특성을 문서화 <br/>\
- 도출 : Brainstorming, Interview, 기존 산출물,문서 <br/>\
- 산출물 : 위험 관리 대장, 위험 보고서 <br/><br/>\
3. 정성적 위험분석 <br/>\
- 개념 : 위험 발생 확률, 영향 평가하여 우선순위 결정 <br/>\
- 도출 : 위험표 (Risk Table) 통한 우선순위 결정 <br/>\
- 산출물 : 위험 관리 대장 갱신 <br/><br/>\
4. 정량적 위험분석 <br/>\
- 개념 : 전체 영향 수치적 분석, 주요 위험의 순위화 <br/>\
- 산출물 : 위험 관리 대장 갱신, 위험 보고서 갱신 <br/><br/>\
5. 위험 대응 계획 <br/>\
- 개념 : 완료 위협 요인 최소화, 기회 강화 조치, 대응방안 개발 <br/>\
- 산출물 : 프로젝트 관리 계획서 갱신 <br/><br/>\
6. 위험 대응 실행 <br/>\
- 개념 : 위험 추적 관리, 잔여 위험 모니터링, 신규 위험 식별 <br/>\
- 산출물 : 위험 관리 대장 갱신, 위험 보고서 갱신 <br/><br/>\
7. 위험 감시 및 조치<br/>\
- 개념 : 위험요인의 변화를 감시, 감독, 모니터링, 발생시 조치 <br/>\
- 산출물 : 작업 성과 정보, 프로젝트 관리 계획서 갱신 <br/><br/>\
# 위험 관리 대응 전략 수에 회전완 활공강<br/>\
<공통> <br/>\
1. 수용 <br/>\
- 개념 : 낮은 수준, 인지만 하고, 대응 계획 미수립 <br/>\
- 사례 : 무대응 <br/>\
2. 에스컬레이션 <br/>\
- 개념 : 기회가 프로젝트 범위를 벗어난 경우, 다른 부서, 담당자에게 이관 <br/>\
- 사례 : 보고 <br/><br/>\
<위협> <br/>\
1. 회피 <br/>\
- 개념 : 원인 제거 위한 프로젝트 관리 계획서 변경 <br/>\
- 사례 : 프로젝트 중단, 프로젝트 계획 변경 <br/>\
2. 전가 <br/>\
- 개념 : 3자 이전 <br/>\
- 사례 : 보험 가입, 조달 프로세스 활용 <br/>\
3. 완화 <br/>\
- 개념 : 수용 가능 수준으로 감소시키는 활동 <br/>\
- 사례 : 단순한 프로세스 선택, 더 많은 테스트 수행 <br/><br/>\
<기회> <br/>\
1. 활용 <br/>\
- 개념 : 불확실성 감소, 발생 확률 증대 <br/>\
- 사례 : 자원 투입으로 프로젝트 조기 종료 <br/>\
2. 공유 <br/>\
- 개념 : 3자와 이익 공유, 편익 증가 <br/>\
- 사례 : 3자와 제휴관계 수립 <br/>\
3. 강화 <br/>\
- 개념 : 긍정적 영향 리스크, 원인 식별하여 발생 확률 증가 <br/>\
- 사례 : 컨설팅 활용 <br/><br/>\
* Risk Table 예시 <br/>\
<img src = "./img/RiskTable.png" style = "max-width:100%; height:auto;"><br/><br/>\
* 라이지움 85회 1교시 2번<br/>\
* KPC 94회 2교시 2번 \
',
...
# 특징 : 프로젝트 관리를 위한 프로세스 그룹 / 프로세스 취합을 위한 주제 그룹<br/>\
<img src = "./img/SWE1_42_1.PNG" style = "max-width:100%; height:auto;">\
',

// [ISO 21500]- ISO 15504(SPICE)
'# 정의 : 프로세스 평가 모델 / SW 프로세스 개선, 평가 / 2차원 구조 <br/>\
- 특정조직의 SW프로세스를 개선,평가하기 위한 2차원 구조의 국제표준 프로세스 평가모델<br/><br/>\
# 암기 <br/>\
1. 구성(9) : 개프심가모자프공용 <br/><br/>\
2. 2차원 평가모델<br/>\
- X : CESMO <br/>\
- Y : IPMEPO <br/><br/>\
# 구성 <br/>\
1. 수행능력차원 (Y축/PAM) : IPMEPO <br/>\
(0) Incomplete <br/>\
(1) Performed <br/>\
(2) Managed <br/>\
(3) Established <br/>\
(4) Predictable <br/>\
(6) Optimizing <br/><br/>\
2. 프로세스 차원 (X축/PRM) : CESMO <br/>\
- 기본(CUS, ENG) <br/>\
- 지원(SUP) <br/>\
- 조직(MAN, ORG) <br/>\
=> CUS(4) : 획득, 공급, 요구사항도출, 운영 <br/>\
=> ENG(2) : 개발, 유지보수 <br/>\
=> SUP(8) : 품검확합감문형문 <br/>\
=> MAN(4) : 관리, 프로젝트관리, 품질관리, 위험관리 <br/>\
=> ORG(6) : 조직배치, 개선활동프로세스, 인력관리, 기반관리, 측정도구, 재사용 <br/>\
=> 5개의 프로세스 범주, 24개의 top-level 프로세스, 16개의 second-level process(ver3.3) <br/>\
=> ISO/IEC 12207 SW 생명주기 프로세스 기반 <br/><br/>\
<img src = "./img/ISO15504_1.png" style = "max-width:100%; height:auto;"><br/><br/>\
<img src = "./img/ISO15504_2.png" style = "max-width:100%; height:auto;"><br/><,br/>\
<img src = "./img/ISO15504_3.png" style = "max-width:100%; height:auto;"><br/><br/>\
* 배경(3) : 9000-3 SW 특성x, CMMI대항, 12207의 What만 있고 How없는 문제 개선 <br/><br/>\
<img src = "./img/ISO15504_4.png" style = "max-width:100%; height:auto;">\
',
...
# 기법 <br/>\
- Peer Review, Management Review, Techinal Review, Walkthrough, Inspection <br/><br/>\
...
- 9126-2 : 외부 메트릭 <br/>\
- 9126-3 : 내부 메트릭 <br/>\
- 9126-4 : 사용중 메트릭 <br/><br/>\
# 주특성 <br/>\
- 기능성, 신뢰성, 사용성, 효용성, 유효성, 이식용이성 \
',
...
// ISO 25010
'# 정의 : 제품품질 국제표준 <br/>\
- 컴퓨터 시스템 및 소프트웨어 제품의 제품품질에 대한 구체적인 품질모델을 제시한 국제표준 <br/>\
- ISO/IEC 25000(SQuaRe)의 품질모델 부분 ISO/IEC 2501n (사용자 품질모델, 제품 품질모델, 데이터 품질모델)중 한 부분 <br/><br/>\
# 주특성 : 기능적합성, 신뢰도, 사용성, 수행효율성, 유용성, 이동성, 호환성, 보안 \
',
...
- 구성 : 일계개구평평 <br/>\
- 특성(4) : 반재공객 <br/><br/>\
# 특징 : 반재공객 - 반복성, 재사용성, 공정성, 객관성 <br/><br/>\
# 구성 : 개계개획평문 <br/><br/>\
<img src = "./img/ISOIEC14598_1.png" style = "max-width:100%; height:auto;"><br/><br/>\
...
- 소프트웨어진흥법 제13조 <br/><br/>\
# 품질 모델 <br/>\
- ISO/IEC 25023 : SW 품질특성 <br/>\
- ISO/IEC 25051 : 패키지 SW 품질 요구사항과 시험 <br/>\
- ISO/IEC 2504x : 14598 SW 제품 특징 \
',
...
- 소스코드 접근성 용이 <br/>\
- 소프트웨어 개발 비용 절감 <br/>\
- 다수 개발자나 공급자, 서비스 중심의 수익모델로 활용 가능 <br/>\
2. 단점 <br/>\
- 소프트웨어 문서 정보 부족 <br/>\
- 소프트웨어 불확실한 개발 일정 <br/>\
- 소프트웨어 라이선스 문제 및 보안 문제 <br/><br/>\
# 도입 목적 <br/>\
- 디지털 변혁 <br/>\
- IT 인프라 현대화 <br/>\
- 애플리케이션 현대화 <br/>\
...
- SW 품질 향상 <br/><br/>\
# 오픈라이선스 의무사항 <br/>\
- 저작권, 개발자 및 기여자 정보의 표시 <br/>\
- 코드를 수정한 경우 수정한 정보의 표시 <br/>\
- 라이선스 정보의 제공 <br/>\
- 같은 라이선스로 재배포할 것 (카피레프트) <br/>\
- 소스코드의 제공 <br/><br/>\
...
// 오픈소스 라이선스 분류
'# 허용적 라이선스 <br/>\
- 기존 오픈소스 라이선스를 수정하여 배포 가능하며 다른 라이선스로 전환 할 수 있음 <br/>\
- 해당 라이선스가 적용된 오픈소스는 공개하지 않아도 됨 <br/>\
- 종류 : Apache 2.0, BSD-2, BSD-3, MIT 라이선스 <br/><br/>\
# 약한 카피레프트 라이선스 <br/>\
- 기존 오픈소스 라이선스가 명시한 허가 및 의무사항을 삭제 또는 변형하지 않는 범위에서 새로운 내용을 추가 및 다른 라이선스로 전환 가능 <br/>\
- 해당 라이선스가 적용된 파일 혹은 모듈 공개 의무 존재 <br/>\
- 종류 : EPL 1.0, EUPL 1.0, LGPL 2.1, LGPL 3.0, MPL 2.0, MS-PL 라이선스 <br/><br/>\
# 강한 카피레프트 라이선스 <br/>\
- 기존 오픈소스 라이선스를 문자 그대로 유지할 것을 요구하며 다른 라이선스로 전환할 수 없음 <br/>\
- 해당 라이선스가 적용된 오픈소스 혹은 SW 결과물을 공개해야 함 <br/>\
...
# 구성 : 제사실 - 제품, 사용자문서, 실행프로그램 <br/><br/>\
# 절차 : 제품 설명서 시험 > 사용자 문서 시험 > 실행 프로그램 시험 > 시험 기록 > 시험 보고서 작성 <br/><br/>\
* ISO/IEC 25051로 대체 <br/><br/>\
<img src = "./img/ISOIEC12119.png" style = "max-width:100%; hegiht:auto;">\
',

// 46
'# 정의 : SW SDLC 프로세스 / 활동 / Task 정의한 국제표준 <br/><br/>\
# 암기 <br/>\
1. 구조(3) <br/>\
- 기본 : 획공개운유 <br/>\
- 조직 : 개훈기관 <br/>\
- 지원 : 품문문형 <br/><br/>\
2. 유지보수 프로세스(6) : 프문변유이소 <br/><br/>\
# 구성 : 3개의 생명주기 프로세스, 17개의 세부프로세스, 74개 활동(Activity) 및 224개의 세부활동(Task)로 구성 <br/>\
- 기본(획공개운유) : 획득, 공급, 개발, 운영, 유지보수 <br/>\
- 지원(품검확합감문형문) : 품질경영관점(품질보증프로세스, 검증, 확인, 합동검토, 감사), 문서화, 형상관리, 문제해결 <br/>\
- 조직(관기훈개) : 관리관점(착수/범위정의, 계획, 실행/통제, 검토/평가, 종료), 기반구조, 훈련, 개선프로세스(프로세스 확립, 프로세스 평가, 프로세스개선) <br/><br/>\
# 유지보수 프로세스 <br/>\
- 프로세스 구현 <br/>\
- 문제 및 변경 분석 <br/>\
- 변경 구현 <br/>\
...
// ASPICE
'# 정의 : 자동차 분야 공통 표준 프로세스 모델 / ISO/IEC 33020 (15504), 12207 기반 / SW<br/>\
- 자동차 전자제어장치(ECU) 품질 문제 해결 및 자동차 분야 SW 개발조직의 프로세스 성숙도 수준을 심사하는 ISO/IEC 33020((구)15504) 및 ISO/IEC 12207 기반의 공통 표준 프로세스 모델 <br/><br/>\
# 암기 <br/>\
- PAM : 33020 : 수-IPMEPI <br/>\
- PRM : 12207 : 프-어.스플.시소 / 서/ 맨.핌.레우 : 3프로세스군 : 32프로세스 <br/><br/>\
# 구성 <br/>\
1. 수행능력 차원(Y축/PAM/ISO IEC33020) : IPMEPI <br/>\
(0) Incomplete <br/>\
(1) Performed <br/>\
(2) Managed <br/>\
(3) Established <br/>\
(4) Predictable <br/>\
(5) Innovated <br/>\
=> Process Assessment Model 공급업체 역량평가 위한 FW, 3단계 심사절차(준비>심사이행>보고) 6단계 프로세스 평가 모델 <br/><br/>\
2. 프로세스 차원(X축/PRM/ISO IEC12207) : 어서시소서매프리 <br/>\
- 기본 : ACQ, SPL, SYS, SWE <br/>\
- 지원 : SUP <br/>\
- 조직 : MAN, PIM, REU <br/><br/>\
(1) 기본생명주기<br/>\
- ACQ(1~7) : 계약체결, 협렵업체 모니터링, 기술적요구사항, 법적행정적요구, 프로젝트요구, 제안요청, 협력업체 자격요건 <br/>\
- SPL(1~2) : 협력업체입찰, 제품릴리즈 <br/>\
- SYS(1~5) : 시스템 요구사항도출, 분석, 설계, 시스템 자격테스트, 시스템 통합 및 통합테스트 <br/>\
- SWE(1~6) : SW요구사항분석, 설계, 상세설계 및 구현, 자격테스트, 통합 및 통합테스트, SW단위 검증 <br/>\
(2) 지원생명주기 <br/>\
- SUP(1~7) : 품질보증, 검증, 협동검토, 문서화, 형상관리, 문제해결관리, 변경요청관리 <br/>\
(3) 조직생명주기 <br/>\
- MAN(1~3) : 프로젝트관리, 위험관리, 평가프로세스 <br/>\
- PIM(1)   : 프로세스 개선 프로세스 <br/>\
- REU(1)   : 재사용 프로그램 관리 프로세스 <br/><br/>\
- Process Reference Model : SW 개발에서 이행하여야 할 프로세스 참조모델 <br/>\
- 3개의 프로세스 군(3 Process Group), 32개의 프로세스 <br/><br/>\
# ASPICE 국내외 동향 <br/>\
- BMW, 다임러, 아우디, 볼보 등은 ASPICE 2~3레벨 수준의 인증을 요구중 <br/>\
- 현대자동차 감마2 엔진개발 프로젝트도 레벨2 이상 인증업체 선호가 예상됨 <br/>\
- 현재 국내 ASPICE 인증업체는 겨우 10여곳에 불과함. (납품 가능업체는 3개사 정도 수준) <br/><br/>\
',
...
# 성숙도 <br/>\
- 단계 : Initial - Managed - Defined - Quantiatively Managed - Optimzing <br/>\
- 연속 : Initial - Performed - MDQM \
',
