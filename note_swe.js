...
- SW SDLC 단계의 산출물을 체계적으로 관리하여 SW 가시성 및 추적성을 부여하여 품질 보증을 향상시키는 기법 <br/><br/>\
# 구성요소 <br/>\
...
# 베이스 라인 <br/>\
<img src = "./img/ShapeAdmin.png" style = "max-width:100%; height:auto;">\
',
...
# 점검 분야 <br/>\
- 개발 소프트웨어 : 릴리즈 및 배포, 테스트 지원, 장애 <br/>\
- 인프라 : 서비스 수준  관리, 서비스 보고, 서비스 연속성, 용량 <br/><br/>\
* KPC 92회 2교시 1번\
',
...
# 점검 분야 <br/>\
- 개발 소프트웨어 : 모니터링, 장애처리, 사용자 지원, 성능관리 <br/>\
- 상용 소프트웨어 : 유지보수 계획, 표준 및 절차, 업그레이트 및 패치, 일상지원 <br/>\
- 인프라 : OS 업그레이드 및 패치, HW 업그레이드, 예방점검, 긴급/장애처리 <br/><br/>\
* KPC 92회 2교시 1번\
',
