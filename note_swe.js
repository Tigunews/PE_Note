...
'[설계단계]- 소프트웨어 아키텍처',
'[설계단계]- 소프트웨어 아키텍처 모델',
'[소프트웨어 아키텍처]- 데이터 중심형 모델',
'[소프트웨어 아키텍처]- 클라이언트-서버 모델',
'[소프트웨어 아키텍처]- 계층형 모델',
'[소프트웨어 아키텍처]- MVC 모델',
'[소프트웨어 아키텍처]- Pipe & Filter',
'[소프트웨어 아키텍처]- Batch Process',
'[설계단계][소프트웨어 아키텍처]- IEEE 1471',
'[설계단계][소프트웨어 아키텍처]- ISO/IEC/IEEE 42010',
...
// ISMP
'# 정의 : 정보시스템 구축을 위한 분석 활동 <br/>\
- Information System Master Plan <br/>\
- 특정 SW 개발 사업에 대한 상세분석과 제안요청서(RFP)를 마련하기 위해 현황 및 요구사항을 분석하고 기능점수 도출이 가능한 수준까지 요건을 상세히 기술하여, 구축 전략 및 이행 계획을 수립하는 활동 <br/><br/>\
# 필요성 <br/>\
- ISP 수행범위 한계점 해결 <br/>\
- 부적절한 발주 관행 개선 <br/>\
- 기능/기술/비기능에 대한 요구사항 명확화 <br/><br/>\
# 수행활동 (착방분정수) <br/>\
...
// 소프트웨어 아키텍처 스타일
'# 정의 : 아키텍처 / 시스템 품질 달성 방법 / 패턴 및 방법론 <br/>\
...
- 분석유형 : 정역(도지시) <br/><br/>\
# 방법론 유형 <br/>\
<img src = "./img/SW_Architecture_평가모델.png" style = "max-width:100%; height:auto;"><br/>\
...
- 형상버전 : 기준선 설정 이후 일어난 변경 기록 <br/><br/>\
# 절차 (식통감기) <br/>\
- 식별 : 소스코드 목록, 기준선, 관리체계 <br/>\
- 통제 : 변경 요청서, 검토,승인서, 변경 보고서 <br/>\
- 감사 : 계획서, 보고서 <br/>\
- 기록 : 상태 기록 문서, 상태 보고서 <br/><br/>\
# 도구 <br/>\
1. 저장관리 측면 <br/>\
...
# 감리대상 (전자정부법 57조) <br/>\
- 의무감리 : 사업비 5억이상, 대국민 서비스, 민원 업무 / 시행령 71-1,2 <br/>\
