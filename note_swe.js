...
// [정책]- 산업의 디지털 전환 및 지능화 촉진법
'#개요 : 산업현장 축적데이터 기반 생상효율 강화, 권리 통한 신산업 진출<br/><br/>\
#법안 상세내용<br/>\
...
3. 산업데이터 신규 생성자에게 <font color = "red">사용/수익권리 부여</font> > 권리침해방지를 위한 보호원칙제시<br/>\
4. 산업부 장관은 산업데이터 <font color = "red">생성, 활용 환경 보장/지원</font><br/>\
5. 산업데이터 활용지원 <font color = "red">전문회사 등록의무부여</font> 지원사항 규정/<font color = "red">표준화</font><br/><br/>\
#대응전략<br/>\
