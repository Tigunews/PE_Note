...
# 설계 원리 <br/>\
- 분할과 정복 : 상향식 <br/>\
- 추상화 : 과정, 데이터, 제어 추상화 <br/>\
- 단계적 분해 : 하향식 <br/>\
- 모듈화 : 작업 단위화, 응집도 및 결합도 <br/>\
- 정보은닉 : 모듈간 독립화, 인터페이스 통해 필요한 정보만 송수신 <br/><br/>\
# 종류 <br/>\
1. 정방향 분석 <br/>\
- 개념 : 초반 의사결정, 상세 설계 <br/>\
- 특징 : 일관성 유지, 위험 예방 <br/>\
...
# Process <br/>\
<img src = "./img/SWArchitectureProcess.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 절차별 활동 <br/>\
- 요구분석 : 요구사항 식별, 기능/비기능 요구사항 명세 <br/>\
- 아키텍처 분석 : 품질 속성 식별, 품질 속성 우선순위화 <br/>\
- 아키텍처 설계 : 관점 정의, 아키텍처 스타일 선택, 후보 아키텍처 도출 <br/>\
- 검증 및 승인 : 아키텍처 평가, 아키텍처 승인 <br/><br/>\
# 고려사항 <br/>\
- 기능 요구사항 : 설계 단계에서 책임 할당 <br/>\
- 품질 속성 : 시스템, 비즈니스, 아키텍처 품질속성 <br/>\
- 제약 사항 : 프로그래밍 언어, Legacy 재사용, H/W, COTS <br/>\
<font color = "red">* COTS(Commercial, off-the-shelf) : 완성품으로 일반 대중에게 판매, 대여 또는 권한 부여할 수 있는 컴퓨터 SW, HW , 기술, 제품</font><br/><br/>\
* ITPE 9회 관리 1교시 9번 <br/>\
* ITPE 6회 관리 4교시 1번\
',
...
// 화이트 박스 테스트
'# 정의 : 우너시코드 오픈 / 모든 경로 테스트 / 설계 방법 <br/>\
- 모듈의 원시코드를 오픈시킨 상태에서 원시코드의 논리적인 모든 경로를 테스트하여 테스트 케이스 설계하는 방법 <br/><br/>\
# 유형 <br/>\
- 문장 검증 : 적어도 한번씩 수행 / 1234567<br/>\
- 선택 검증 : 선택하는 부분만 검증 / 1234567 1234561 <br/>\
- 경로 검증 : 수행 가능한 모든 경로 검사 <br/>\
- 조건 검증 : IF, While 문장 내 조건 조사 / x>1 or y <10 Outrange 둘 다 <br/><br/>\
# 비교 <br/>\
<img src = "./img/WhiteBoxBlackBox.png" style = "max-width:100%; hegiht:auto;"><br/><br/>\
* 라이지움 93회 응용 1교시 13번 \
',
...
# 사례 <br/>\
<img src = "./img/RefactoringExample.png" style = "max-width:100%; height:auto;"><br/><br/>\
* ITPE 9회 관리 2교시 2번 <br/>\
* 라이지움 78회 3교시 1번\
',
...
// 품질관리
'# 정의 : 품질관리 시스템 구현 / 정책, 절차 활용 / 지속적 프로세스 개선 활동 <br/>\
- 프로젝트 환경 안에서 조직의 품질관리 시스템을 구현하기 위하여 정책과 절차를 활용하고, 상황에 따라 수행조직을 대신하여 실행되는 지속적인 프로세스 개선 활동 <br/><br/>\
# 구성 <br/>\
- QM : 요구사항, 표준 식별, 준수 입증방법 문서로 명시하는 프로세스 <br/>\
- QA : 품질 측정치 결과, 품질요구사항 감시 프로세스 <br/>\
- QC : 성과 평가, 실행 결과 감시, 기록 프로세스 <br/><br/>\
...
- 성과 <br/><br/>\
# 유형 <br/>\
1. 내용이론 : 동기 욕구가 무엇이냐 <br/>\
- 욕구 5단계 이론(매슬로우) : 생리적 < 안전 < 사회적 < 자존 < 자아실현 <br/>\
- ERG 이론(엘더퍼) : 매슬로우 이론을 존재, 관계, 성장 요소로 분류 <br/>\
- 2요인 이론(히츠버그) : 위생/동기 요인 <br/><br/>\
2. 과정이론 : 어떻게 그 행동을 이끄냐 <br/><br/>\
- 기대 이론 : 개인 업무 성과 -> 적절한 보상 <br/>\
- 공정성 이론 : 공정 평가, 보상 인식 <br/><br/>\
* ITPE 9회 관리 2교시 6번 <br/>\
* KPC 74회 2교시 4번\
',
...
1. 욕구 5단계(매슬로우)<br/>\
- 안전 욕구 : 복지제도, 근무 환경 개선 <br/>\
- 사회적 욕구 : 워크샵 <br/>\
- 자존 욕구 : 팀원의 리더 역할 순환식 수행 <br/>\
- 자아실현 욕구 : 성장 비전 제시 <br/><br/>\
2. ERG 이론(엘더퍼) : 존재, 관계, 성장<br/>\
- 존재 욕구 : 안식년 제도 <br/>\
- 관계 욕구 : 사내 동아리 <br/>\
- 성장 욕구 : 자격증, 교육 환경 제공 <br/><br/>\
3. 허즈버그(2요인) : 위생, 동기 <br/><br/>\
* ITPE 9회 관리 2교시 6번 <br/>\
* KPC 74회 2교시 4번 \
',
...
# 개념도 <br/>\
<img src = "./img/ConflictResolution.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 해결전략 <br/>\
- 강요 : 긴급한 사안 결정, 자신의 의견 옳다고 믿는 주요 안건 <br/>\
- 철회 : 이슈가 사소함, 일시적 물러남 <br/>\
- 문제 해결 : 공감대 형성, 문제 해결 <br/>\
- 수용 : 자신의 의견 틀림, 조직의 조화,안정 중요한 경우 <br/>\
- 타협 : 복잡한 문제 잠정적 해결책 도출 <br/><br/>\
* ITPE 9회 관리 2교시 6번 \
',
...
# 특징 <br/>\
- UseCase Driven : 사용자 요구사항 분석으로 컴포넌트 식별 <br/>\
- Blackbox Reuse : I/F 기반 컴포넌트 효율 <br/>\
- Iteration : 개발 단계 반복 통해 위험 최소화 <br/>\
- Lossely Coupled : MVC 모델에 기반한 약결합 구현 <br/><br/>\
# 장점 (<font color = "red">생고재변기관사</font>) <br/>\
- 생산성 : 시간 단축 <br/>\
...
- Catalysis : UML 표기기반 CBD, 분산시스템 모델링/구축 <br/><br/>\
# 개발 SW 평가요소 <br/>\
- 응집도 : 컴포넌트 기능의 충실도, 높을 수록 좋음 <br/>\
- 결합도 : 컴포넌트간의 관련성, 낮을 수록 좋음 <br/>\
- 독립성 : 플랫폼 종속성 여부, 종속되지 않아야 함 <br/>\
- Round Trip ENG : 분석/설계/구현/테스트 자동화 도구 지원 여부 <br/><br/>\
# 컴포넌트 식별 방법 <br/>\
- 유즈케이스 시나리오 분석 : include(동일 반복), extend(특정 수행) <br/>\
- 설계 단계 분석 : 공통 UI, 공통 UI 컨트롤 <br/>\
- 클래스 상관관계 분석 : Core 클래스 + 종속 클래스 그룹핑 <br/>\
- Usecase와 클래스 상관 관계 분석으로 도출 <br/>\
- 전문가 판단 <br/><br/>\
...
# 대기업 참여제한 제도 예외사항 <br/>\
- 국가 안보 관련된 사업(트랙1) : 국방,외교,치안,전력 사업 <br/>\
- 인공지능등 신기술 도입 분야 (트랙2) <br/>\
- 민간투자형 SW사업(트랙3) : 민간 50% 자본 / 서울시 스마트 교통카드 시스템, 안산시 U-City <br/>\
...
- 기존 설계와 구현을 한 사업자가 수행하는 일괄발주 방식에서, 요구사항 명확화를 위한 선행사업(요구사항~기본설계)과 후속사업(상세설계~인수과정)의 2단계로 분리하여 분석,설계를 우선 실시하고, 설계 결과 산출물에 의거하여 구현사업을 수행하는 방식 <br/><br/>\
# 법적근거 <br/>\
- SW진흥법(개정안) 제43조 (SW사업의 과업범위)<br/>\
- SW사업 관리감독에 관한 일반기준 제5조(발주준비) <br/><br/>\
# 사업의 특성 고려 (의무사항 x) (<font color = "red">다대고필</font>)<br/>\
- <font color = "red">다년도</font> 사업 <br/>\
- 대국민 서비스 지향사업 및 공익서비스 추구하는 <font color = "red">대규모</font> 사업 <br/>\
- 다수의 기관 연계사업에 따른 <font color = "red">고도화</font> 사업 <br/>\
- 기타 업무 복잡성 의한 <font color = "red">필요</font> 사업 <br/><br/>\
# 구성요소 <br/>\
