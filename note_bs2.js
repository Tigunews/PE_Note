...
# 군집분석의 과정 <br/>\
1. 거리측도 선택 <br/>\
- 어떤 측도가 대상들을 서로 얼마나 유사한지 또는 다른지를 판단하기 위해 필요<br/>\
- 유클리디안 거리, 도시-블록거리 등 <br/><br/>\
2. 군집화 절차 선택 <br/>\
- 계층적 : 단일 결합법, 완전결합법, 평균결합법, Ward 법 <br/>\
- 비계층적 : K-means 등 <br/><br/>\
3. 군집의 수 결정 <br>\
- 이론적, 개념적 또는 실재적 고려사항이 어떤 군집의 수를 제시 <br/>\
- 계층적 군집화에서는 군집이 결합되는 거리가 기준으로 이용 <br/>\
- 비계층적 군집화에서는 집단 간 분산에 대한 집단 내 분산합계의 비율이 군집의 수에 대비하여 도시될 수 있음 <br/>\
- 군집의 상대적인 크기가 의미를 가져야 함 <br/><br/>\
4. 신뢰성과 타당성의 평가 <br/>\
- 상이한 거리 측도를 이용하여 동일한 자료에 대한 군집분석을 수행 <br/>\
- 군집화의 상이한 방식을 이용하고 그 결과를 비교 <br/>\
- 자료를 반복적으로 반분, 각각의 반분에 대해 개별적으로 군집화 수행 <br/>\
- 무작위로 변수들을 제거 감소된 집합에 근거하여 군집화 실행 <br/>\
- 비계층적 군집화에 있어서의 해는 집합에 있는 사례의 순서에 의존 <br/><br/>\
# 군집의 유형 <br/>\
1. 거리 중심 <br/>\
- 계층적 군집 : Hierarchical한 군집이 다른 군집에 포함되거나 군집간의 중복이 허용되지 않고 계보형식이 나뭇가지와 같은 구조 <br/>\
- K-means : 두 개체간의 비 유사성을 정량화하여 위에서 아래(top-bottom) 방식으로 K개의 군집을 형성하는 방법 <br/>\
- SOM : 고차원 자료들(p차원)을 2차원의 좌표계로 사영시켜 위상적인(topological) 성질을 이용하여 군집분석을 하는 방법 <br/><br/>\
2. 자원축소 <br/>\
- 주성분분석(PCA) : 원래의 변수들을 선형 변화하여 주성분이라고 불리는 새로운 변수를 만들어내는 분석법 <br/>\
