...
# 주요 기술요소 <br/>\
1. 광원기술 <br/>\
- 양자광원 : 단일광자에서 양자 얽힘 상태 구현 기술 <br/>\
- 광자 검출기 : 검출 기술 <br/><br/>\
2. 키분배 기술 <br/>\
- Optical-Fiber QKD : 광케이블 Node 2 Node 구축 <br/>\
- Free-Space QKD : 저궤도 위성과 QKD 암호 통신 <br/><br/>\
3. 난수 기술 <br/>\
- 의사 난수 : 프로그램 인위 난수 <br/>\
- 양자 난수(QRNG) : 물리적 현상 관측값 숫자 변환 방식 <br/><br/>\
4. 양자 암호 프로토콜 <br/>\
- BB84 : OTP, P&P, Two Way Protocol <br/>\
- COW04 : 환경변화 민감, 고속 동작, One Way Protocol <br/><br/>\
5. 시스템 고도화 기술 <br/>\
- 양자 중계기 : 광섬유 기반 장거리 위한 증폭기 <br/>\
- 양자 다중화 중계기 : N:N 가능 전용 중계기 <br/><br/>\
# 기존 암호 통신 한계 <br/>\
1. Shore <br/>\
...
- 스마트폰 등의 인증절차를 이용하여 정보를 수집한 후, 인증자를 통해 인증 결과 값을 생성하여 서버로 전송하고 서버에서 인증 결과 값을 검증하는 인증기술 <br/><br/>\
# 이력 <br/>\
