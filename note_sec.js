...
// 공동인증서
'# 개념 : 공개키 + 소유자 정보 / 디지털 신분증 및 인감<br/>\
- 전자서명의 검증에 필요한 공개키(전자서명검증정보)에 소유자 정보를 추가하여 만든 일종의 디지털 신분증(증명서) 및 디지털 인감 증명<br/><br/>\
# 구성요소 <br/>\
- 전자서명검증 정보 : 공개키<br/>\
- 소유자 정보 <br/>\
- 전자서명생성 정보 : 개인키 <br/><br/>\
...
// 금융인증서
'# 개념 <br/>\
- 금융기관에서 공동인증서와 동일한 방식으로 인증을 거친 후 금융결제원의 사용인증을 거쳐 발행되는 인증서 <br/><br/>\
# 특징 <br/>\
1. 장점 <br/>\
- 클라우드 보관 <br/>\
- Active X 사용 않음 <br/>\
...
- 비밀번호 단순 : 6자리 <br/>\
- 개인 범용 무료 <br/>\
- Add-On 가능 :생체 인식, 패턴 등 <br/><br/>\
2. 단점 <br/>\
- 적용 영역 미비 (금융, 증권, 정부기관) <br/>\
- 타행 등록 잔존 <br/>\
- SMS 인증 방식 : 사용자 요금 부담 <br/>\
- 보안 수준 : 개인사용자만을 위한 수준, 행정전자서명(GPKI) 국방전자서명(MPKI) 대체 불가 <br/>\
- 브라우저 쿠키 삭제시 재인증 필요 <br/><br/>\
',
...
- 전자서명(코드서명) : SW 해시 값을 배포 기관의 개인키로 암호화 <br/>\
- 배포 : SW, 코드서명 인증서, 코드서명 값 <br/><br/>\
2. 사용자(무결성 검증) <br/>\
- 인증서 검증 : 코드서명 인증서 진위 검증 <br/>\
- 복호화 : 인증서에서 추출한 공개키로 코드서명 값 복호화 <br/>\
- 검증 : SW 해시값과 복호화된 코드 서명 값 비교/검증 <br/><br/>\
# 인증서 관리 방안 <br/>\
- 인증서 관리 : 별도 관리 시스템, 망분리, 주기적 무결성 점검 <br/>\
- 시스템 보안 강화 : PW 관리, 공용계정 삭제, 최소 권한 원칙 <br/>\
- 보안 업데이트 체계 관리 : 안전한 무결성 검증 기술, 보안 업데이트 서버 IP, URL 변조 확인 <br/>\
- 사고대응 체계 마련 : 인증서 폐기 절차, 비상연락망, 로그 관리  <br/><br/>\
* ITPE 9회 1교시 3번\
',
...
// 인공지능 보안관제
'# 정의 : 지도 학습, 비지도 학습 / 오탐 미탐 / 해결 보안 관제 <br/>\
- 인공지능의 지도학습과 비지도 학습을 통해 보안 관제의 고질적인 문제인 오탐과 미탐의 문제 해결한 보안관제 <br/><br/>\
# 구성도 <br/>\
<img src = "./img/AI_SecurityCenter.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 구성요소 <br/>\
1. 지도학습 <br/>\
- 데이터 : 시그니처 매핑결과, SIEM 정책/로그, 블랙리스트 결과 <br/>\
- 예측 : 이벤트 사고처리, 정/오탐 사고처리 자동화, 미처리/오탐 감소 <br/><br/>\
2. 비지도 학습 <br/>\
- 데이터 : 통계 모델, 행위 분석, 시각 분석 <br/>\
- 예측 : 사용자 변칙활동/이상행위, 미탐 발견 <br/><br/>\
# 적용 위한 사전 준비 <br/>\
- 목표 설정 : 위험한 이벤트 찾기, 숨겨진 이벤트 찾기 <br/>\
- 적용 대상 : 이벤트(IDS/IPS, WAF, DLP), 로그(FW, Web, System) <br/>\
- 데이터 선택 : 탐지명, 탐지결과, CTI 정보, 취약점 정보 <br/>\
<font color = "red">* CTI : Cyber Threat Intelligence </font><br/><br/>\
* ITPE 9회 관리 4교시 6번\
',

// 해킹, 악성프로그램
'# 정의 <br/>\
- 해킹 : 시스템 관리자가 구축해 놓은 보안망을 무력화 시키거나 시스템 관리자 권한을 불법으로 획득하여 다른 사람에게 피해를 주는 모든 행동 <br/>\
- 악성프로그램 : 사용자 정보 탈취, 분산 서비스 거부 공격등 악의적인 목적으로 실행하며, 자기 복제와 정상 파일에 삽입을 수행하는 모든 프로그램 또는 파일 <br/><br/>\
# 해킹 <br/>\
1. 분류 <br/>\
- 크래킹 : 무단 침입, 정부 훔치거나 훼손, 불법행위 <br/>\
- 해킹 : 보안 취약점을 찾아내어 문제 해결, 악의적으로 이용 방지 행위 <br/><br/>\
2. 종류 <br/>\
- 가로채기 : Packet Sniffing <br/>\
- 불법 수정 : SQL Injection, XSS <br/>\
- 서비스 방해 : DOS, DDOS <br/>\
- 제어 <br/><br/>\
# 악성 프로그램 <br/>\
1. 유형 <br/>\
<img src = "./img/MaliciousProgram.png" style = "max-width: 100%; height: auto;">\
',
...
// [랜섬웨어]- 갠드크랩 랜섬웨어
'# 정의 : 홈페이지, 이메일 기반 / RaaS <br/>\
- 홈페이지, 이메일 기반 랜섬웨어 파일 암호화 서비스형 랜섬웨어 <br/><br/>\
# 유형 <br/>\
- 홈페이지 기반 : DBD, Watering hole <br/>\
- 이메일 기반 : 사회공학기법, CBD, 스피어피싱 <br/><br/>\
# 대응방안 <br/>\
1. 관리적 <br/>\
- 수상한 사이트 출입 금지 <br/>\
- 불법 콘텐츠 다운로드 금지 <br/>\
- Emergency 구성, 정보보호 조직 내 랜섬웨어 대응팀 구성 <br/>\
- 주기적 백업, 정보보호 관리체계 강화 <br/><br/>\
2. 기술적 <br/>\
- SW 보안 패치 <br/>\
- 백신 최신 버전 유지 <br/>\
- 주기적 백업 <br/>\
- CDR <br/><br/>\
* KPC 118회 합숙 4일차 1교시 13번\
',
...
// 비즈니스 스캠
'# 정의 : 비즈니스 당사자 메일 해킹 / 결제 시점 / 가로채기 수법 <br/>\
- Business SCAM <br/>\
- 무역 당사자 간의 이메일을 해킹하여 거래 진행 상황을 지켜보다가 결제 시점에 바이어에게 결제 은행이 변경되었다는 메일을 송부하고 결제 대금을 가로채는 수법 <br/><br/>\
# 절차 <br/>\
<img src = "./img/BusinessSCAM.png" style = "max-width:100%; height:auto;"><br/>\
- 이메일 통한 감염 : 스팸 메일, 스피어 피싱, 악성 코드 감염, 이메일 획득 <br/>\
- 유사 이메일 생성 : 알파벳 추가 삭제, 정렬, 글자 변환, 서버 변경 <br/>\
- 거래 진행 중계 : 가짜 메일 이용 MITM <br/>\
- 거래 체결 시 변경 : 바이어 결제 계좌 변경 통지 / 이메일 스푸핑 <br/><br/>\
# 대응 방안 <br/>\
- 관리적 : 이메일 주소 확인, 결재 프로세스, APT 메일 훈련 <br/>\
- 기술적 : 멀티채널 인증, Origin IP 확인, 암호화 메일 전송 \
',
...
// 공급망 공격
'# 정의 : SW 개발사 공급망 / 악성코드 삽입 / 공격 기법 <br/>\
- Supply Chain Attack <br/>\
- SW 개발사의 공급망에 침투하여, SW의 빌드/배포 과정에 악성코드를 삽입/감염/배포하는 공격기법 <br/><br/>\
# 절차 <br/>\
<img src = "./img/SupplyChainAttackMechanishm.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 공격 유형 <br/>\
- 개발 서버 : 악성코드 삽입, 악성코드 감염 <br/>\
- 인증 서버 : 인증서 탈취 <br/>\
- 업데이트 서버 : 패치 파일 감염 <br/><br/>\
# 대응방안 <br/>\
- 기술적 : 패치, 망분리, 접근통제, 자동 로그인 금지, 로그 관리, 계정관리, 개발보안 라이프사이클, 코드서명, Multi Factor <br/>\
- 관리적 : 인증서 폐기 절차, 담당자 교육, 보안관리 체계 및 보안 거버넌스 강화 <br/><br/>\
* ITPE 9회 1교시 8번\
',
...
// 개인정보보호법
'# 정의 : 개인정보 처리 및 보호 사항 / 개인 자유, 권리 보호 / 개인의 존엄과 가치 구현 목적 법<br/>\
...
# ISO/IEC 20889 기준, 가명처리 기법 (<font color = "red">해재암통일가무삭 암토랜스휴 순잡부</font>)<br/>\
...
2. 민간기관 : 자발적 신청 <br/><br/>\
# 체계 (<font color = "red">개행공평</font>)<br/>\
...
// ISO/IEC 29134
'# 정의 : 위험관리 단계 / 개인정보 영향평가 / 수행 방법론 <br/>\
...
// IoT 공통 보안 7원칙
'# 정의 : KISA 배포 / IoT SDLC / 보안 검증 방안 <br/>\
- IoT 기기의 개발 주기에 따라 최초의 설계/개발부터 배포/설치/구성을 통해 운영/관리/폐기 시까지 다양한 보안을 검증하는 방안 <br/><br/>\
# 구성 <br/>\
1. 설계,개발 단계 <br/>\
- 정보보호, 프라이버시 강화 고려한 IoT 제품,서비스 설계 <br/>\
- 안전한 SW, HW 개발 기술 적용 및 검증 <br/><br/>\
2. 배포,설치,구성 단계 <br/>\
- 안전한 초기 보안 설정 방안 제공 <br/>\
- 보안 프로토콜 준수 및 안전한 파라미터 설정 <br/><br/>\
3. 운영,관리,폐기 단계 <br/>\
- 취약점 보안 패치 및 업데이트 지속 이행 <br/>\
- 프라이버시 관리 체계 마련 <br/>\
- 침해 사고 대응 체계 및 책임 추적성 확보 방안 마련 \
',

// IoT Bootstrapping 
'# 개념 : IoT 안전성 / 초기 설치&설정 / 보안기술 <br/>\
- 사물인터넷의 안전성 확보 위해, 초기 설치&설정의 부팅 단계에서 인증/인가 및 보안 파라미터를 설정하는 보안기술 <br/><br/>\
# 동작 단계 <br/>\
<img src = "./img/IoTBootstrappingMechanishm.png" style = "max-width: 100%; height: auto;"><br/><br/>\
# 보안요소 <br/>\
1. 설치 단계 <br/>\
- 인증 : Credential 정보(대칭키, 공개키, PW), 신원정보 유효성 <br/>\
- 인가 : 사용자 및 기기에 부여된 권한 인증 <br/>\
- 계정관리 : NW 자원 사용 이력, 비정상 행위 공격 탐지 <br/>\
- 키분배 : 상호 인증 기기 암호 통신 <br/><br/>\
2. 설정 단계 <br/>\
- 관리서버 접속 정보 : 기기 속한 도메인 관리 서버 정보 설정 <br/>\
- 보안 파라미터 : AES128, AE 암호모드, 초기 계정명 암호, 암호 만료일 <br/>\
<font color = "red">* AE : Authenticated Encryption </font><br/><br/>\
# 기술동향 <br/>\
- PANA : ZigBee, IEEE 802.15.9 에서 NW 인증 및 키 관리 프로토콜 / UDP 적용 <br/>\
- OCF : 크리덴셜 통해 보안 정책 및 접근제어 구현 / DTLS 적용 <br/>\
- BRSKI : 자가보호 구현, 신원 검증 및 네트워크 설정 자동화 <br/>\
<font color = "red">* PANA : Protocol for Carring Authentication for Network Access <br/>\
* OCF : Open Connectivity Foundation <br/>\
* BRSKI : Bootstrapping Remote Secure Key Infrastructres </font><br/><br/>\
* ITPE 9회 1교시 4번\
',
...
- 분석 준비 : 팀 구성, 포렌식 Pack, Guarantee <br/>\
- 증거 획득 : 휘발성, 비휘발성, Memory, Image, Clone, Dump <br/>\
- 증거 보관 : 무결성, 차폐 봉인, MD5 <br/>\
- 증거 분석 : 사본 복사, 상세 분석, 클러스터, 언클러스터(파일 카빙) <br/>\
- 결과 보고 : 보고서 작성, 증거 제출, 연계 확인, 6하 원칙 작성 <br/><br/>\
# 증거유형 <br/>\
1. 자동생성 여부 <br/>\
...
- 소송 또는 규제 요구에 대응하기 위해 종이 또는 디지털 형태로 존재하는 기업의 콘텐츠를 수집, 준비, 검토, 구성, 생산하는 절차 <br/><br/>\
# 절차 <br/>\
<img src = "./img/eDiscovery.png" style = "max-width: 100%; height: auto;"><br/><br/>\
# 구성 단계 <br/>\
1. 정보 시스템 영역 <br/>\
- 정보관리 : 비즈니스 기록 유지 <br/>\
- 식별 : 증거 보존 의무 발효 후 EDRM 수행하여 ESI 구별 <br/>\
- 보존/수집 : 문서 손상 없이 다음 단계 전달 <br/><br/>\
2. 법적 영역 <br/>\
- 처리,검토,분석 : 데이터 양 최소화, 면책성 대한 검토 수행, 법률적 분석 <br/>\
- 산출 : 민감 하지 않거나 면책인 경우 ESI를 요청한 당사자에게 제공 준비 <br/>\
<font color = "red">* EDRM : Electronic Discovery Reference Model <br/>\
* ESI : Electronically Stored Information </font><br/><br/>\
# 디지털 포렌식, e-Discovery 비교 <br/>\
<img src = "./img/DigitalForeinsicEDiscovery.png" style = "max-width: 100%; height: auto;">\
',

// CPO
'# 정의 : 개인정보 관리 총괄 책임자 / 개인정보보호법 31조 <br/>\
- Chiep Privacy Officer <br/>\
- 개인정보보호 계획 및 방침의 수립/시행, 개인정보 처리 실태의 점검 및 감독, 각종 개인정보보호 관련 통계 및 자료의 취합 등의 업무를 수행하는 최고 책임자 <br/><br/>\
# 자격 요건 <br/>\
- 공공 : 고위 공무원, 개인정보 처리 관련 업무 담당 부서의 장(3급) <br/>\
- 민간 : 사업주 or 대표자, 개인정보 처리 관련 업무 담당 부서 부서장 or 개인정보보호 소양자 <br/><br/>\
# 역할 <br/>\
- 내부 관리 체계 수립 <br/>\
- 보안 감사 <br/>\
- 보안 교육 <br/>\
...
// CISO
'# 정의 : 정보보안 위한 총괄 책임자 / 정보통신망법 제45조의 3 <br/>\
- Chief Inforamtion Security Officer <br/>\
- 전략 및 정보 시스템이 기업의 정보 자산을 적절하게 보호하기 위한 목표에 부합되도록 기업의 의사결정에 영향을 미치는 최고의 책임자 <br/><br/>\
# 자격 요건 <br/>\
- 석사 : 정보보호, 정보 기술 분야 <br/>\
- 학사 : 정보보호, 정보 기술 분야 + 업무 3년 <br/>\
- 전문학사 : 정보보호, 정보 기술 분야 + 업무 5년 <br/>\
- 경력 : 정보보호, 정보 기술 분야 격력 10년 <br/>\
- ISMS : ISMS 인증 심사원 <br/><br/>\
# 주요 역할 <br/>\
- 정보보안 전략 수립 <br/>\
- 정보보안 표준 체계 <br/>\
- 정보보안 인식 제고 <br/>\
...
// CVE
'# 정의 : 여러 알려진 SW / 취약점 국제적 식별 체계 <br/>\
- Common Vulunerabilities and Exposure <br/>\
- 발견된 보안 취약점을 분석하여 체계적으로 정리한 보안 취약점 고유번호 체계 <br/><br/>\
...
// CWE
'# 정의 : SW 설정, 설계, 구조 / 약점 분류 <br/>\
- Common Weakness Enumeration <br/>\
- 미국 MITER 기관에서 일반적으로 소프트웨어에서 공통으로 발생하는 잠재적인 보안 약점 분류 체계 <br/><br/>\
# CVE와 관계 <br/>\
<img src = "./img/CVE_CWE.png" style = "max-width: 100%; height: auto;">\
',

// 버그 바운티
'# 정의 : 취약점 신고 / 포상 제도 <br/>\
- 보안 취약점 신고포상제로, 취약점을 찾는 것을 허락한 회사의 제품이나 사이트 등에서 보안 취약점을 발견하면 이를 해당 회사에 통보하여 포상금을 받는 제도 <br/><br/>\
# 절차 <br/>\
<img src = "./img/BugBounty.png" style = "max-width: 100%; height: auto;"><br/>\
- 신고 접수 : 취약점 홈페이지 <br/>\
- 검증 : 취약점 기본 정보 파악 여부 판단 <br/>\
- 1차 평가 : 신규 취약점인 경우, 환경 구축, 테스트 및 평가 기반 평가 <br/>\
- 2차 평가 : 교수, 취약점 전문가, 소프트웨어 제조사 평가 위원회 평가 \
',
...
// 사이버 레질리언스
'# 정의 : 사이버 공간상 위협 / 조직 목표 성과 / 전달할 수 있는 기업의 능력 <br/>\
...
// EMP
'# 정의 : 전자 장비 파괴 / 충격파 공격 <br/>\
- 전자 장비를 물리적으로 파괴시킬 정도의 강력하고 순간적인 전자적 충격파(전자기파)를 이용한 공격 <br/><br/>\
# 구분 <br/>\
- 고출력 비핵 전자파 : 의도적 고출력 전자기파, 유지기간 짧음, 피해 강력 <br/>\
- 고고도 핵 전자기펄스 : 고도 30Km 이상 핵폭발, 감마선, 광범위 <br/><br/>\
# 고고도 핵 전자기펄스 <br/>\
- 감마선 : 핵폭발 <br/>\
- Compton Effect : X, 감마선 비탄성 산란 과정 <br/>\
- 전자기장 : 강력한 자기장 발생 <br/>\
- 고고도 : 40Km <br/><br/>\
# 방호방안 <br/>\
- 복사성 위협(물리적) : 방사펄스 차단, 차기 차폐 <br/>\
- 전도성 위협(통신적) : 차단 필터, 정전 차폐 <br/><br/>\
* 125회 관리 2교시 5번 \
',
);
