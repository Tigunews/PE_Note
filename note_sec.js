...
# 대응 방안 <br/>\
- 사전대응 : 백업, SOAR, 웜스토리지, 테이프스토리지, 망분리, EDR, IPS, IDS, CDR, DRM, 위협 모니터링 <br/>\
- 사후대응 : 위협 네트워크 차단, 물리 장치 격리 및 분석, 복구 프로세스, 신고 및 보험 처리 <br/><br/>\
# 공격 흐름 <br/>\
- File 암호화 > 경쟁사 유출 협박 > 순차적 유출 > DDoS <br/><br/>\
# 종류 <br/>\
1. 공격대상 관점 (블록크랜)<br/>\
...
# 내용 (<font color = "red">수정목이안공개책</font>) <br/>\
