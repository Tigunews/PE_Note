...
# 기법 : K랜압기분 <br/>\
1. K-익명화 : 연결 공격 방어, 준식별자 K개 <br/><br/>\
2. 랜덤 노이즈 추가(상노영) : 민감 원본 데이터 + 노이즈 추가 = 교란된 데이터 <br/>\
- 상관관계 활용 : 확률적 교란 데이터<br/>\
- 노이즈 평준화 : 클러스터링 정확도 향상<br/>\
- 영역기반 교란기법 : 영역 분할후 노이즈 증가<br/><br/>\
3. 압축 기반 교란 기법 : 시계열 데이터 -> 낮은 차원 새로운 공간 매칭 -> R-Tree 같은 다차원 트리로 인덱싱 <br/>\
- 이산푸리에 변환 <br/>\
- 이산웨이블릿 변환 <br/><br/>\
4. 기하학적 교란 기법(회다응) : 데이터 상관관계 미 지원 문제점 보완 <br/>\
- 회전 교란기법<br/>\
- 다중 회전 기법<br/>\
- 응축 교란 기법<br/><br/>\
...
- 프라이버시 보호 질의 <br/>\
- 프라이버시 보호 집계 : 단계별 질의 결과에 노이즈 추가<br/><br/>\
* 아이리포 23회 관리 4교시 5번\
',
