...
// 코드 서명
'# 정의 : 소프트웨어 배포 / SW 무결성 / 해시값에 전자서명 기술 <br/>\
- 개발사에서 소프트웨어를 인터넷에 배포할 때, SW의 무결성 증명 위해 SW 해시값에 전자서명하는 기술 <br/><br/>\
# 매커니즘 <br/>\
<img src = "./img/CodeSignFlow.png" style = "max-width:100%; height:auto;"><br/><br/>\A
* ITPE 9회 1교시 3번\
',
