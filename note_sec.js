...
# 기법 : K랜압기분 <br/>\
1. K-익명화 : 동일속성 적어도 k개 <br/><br/>\
2. 랜덤 노이즈 추가(상노영) : 교란 발생 <br/>\
- 상관관계 활용 : 확률적 교란 데이터<br/>\
- 노이즈 평준화 : 클러스터링 정확도 향상<br/>\
- 영역기반 교란기법 : 영역 분할후 노이즈 증가<br/><br/>\
3. 압축 기반 교란 기법 : 다차원 트리 <br/>\
- DET 기법 : 푸리에 <br/>\
- DWT 기법 : 중요계수 <br/><br/>\
4. 기하학적 교란 기법(회다응) : 데이터 상관관계 및 민감 속성 보호 <br/>\
- 회전 교란기법<br/>\
- 다중 회전 기법<br/>\
- 응축 교란 기법<br/><br/>\
5. 분산 프라이버시(안질집) : 노드별 마이닝후 집계 <br/>\
...
# 종류 <br/>\
- HeaAN : 천정희 교수 개발, 연산마다 라운딩 <br/>\
- HELib : IBM 개발, 준 유사 암호화 구현 소프트웨어 라이브러리 <br/>\
- SEAL : MS 개발, 동형암호 기능 수행 소프트웨어 라이브러리 <br/><br/>\
# 활용 <br/>\
