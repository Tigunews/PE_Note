...
// OECD Privacy 8원칙
'1. 수집제한 원칙 : 수집시 정보주체 알리거나 동의 <br/>\
2. 정보내용의 원칙 : 사용목적 부합, 필요 범위내 유지 <br/>\
3. 목적명확화의 원칙 : 수집시 목적 명확 제시 <br/>\
4. 이용(사용)제한의 원칙 : 목적 이외 용도 누출, 사용 금지 <br/>\
5. 안전보호의 원칙 : 유출에 대비, 합리적 보안 장치 마련 <br/>\
6. 공개의 원칙 : 개발, 운영, 정책 관한 일반적인 공개 정책 취해야함<br/>\
7. 개인 참가의 원칙 : 자기 정보 열람 가능, 삭제, 정정, 보완, 수정 청구 가능 <br/>\
8. 책임의 원칙 : 정보 관리책임자 위 원칙 지켜지도록 제반 조치 취할 책임 있음 <br/><br/>\
* 123회 응용 4교시 5번\
',
