...
'On the right side of the picture, there\'s a couple with a dog',
'The woman is crouching down - maybe she\'s trying to take a picture of the dog',
'The man and the dog are walking away from the other people',
'There are some big trees planted along the fence, and a few buildings are behind the trees',
'It is a sunny day and it looks very calm and peaceful',
'The last time I used a taxi was last Thursday, and I took it to get to my hoyuse from my office',
'If I were taking a long taxi ride, I\'d prefer to spend the travel time listening to music on my phone',
'While listening to music, I\'d look at the streets through the window',
'If taxi fares were cheaper, I would take taxis more often',
'Taxi fares are very expensive compared to the cost of taking public transportation, so i can\'t afford to use taxis often',
'Also, because taxi fares are getting higher and higher tese days, it is actually more economical to drive my own car',
'If I were considering buying a house, a real estate agent\'s advice would most influence my decision',
'Real estate agents are professionals who know exactly what to do',
'So, they would give me useful tips for each step of buing a house',
'Also, if a house I wanted to buy cost too much, they would try to get me a better deal',
'Real estate agents work on commission, so they work hard to negotitateprices and close deals',
'Therefore, I\'d take advice from a real estate agent when considering buying a house',
'Sure. Let me see. We will be offering two classes for beginners',
'One is Beginning Violin, which is from 10 to 11 A.M. on Mondays. The instructor is Hal Silver',
'The other one is Beginning Flute from 10 to 11 A.M. on Thursdays. Steven Blume will leat that class',
'Actually, no. All of our classes are on weekdays',
'The fall program starts on October 1st and the price is 130 dollars per class',
'I see two people standing at a copy machine in an office',
'It look like the people are having a conversation',
'One of them is a man who is wearing a blue shirt, and he\'s taking a piece of paper out of the copy machine',
'The other is a woman who is wearing a dark brown suit and holding a piece of paper',
'There is a white board hanging on the wall in the background',
'I think these people are co-workers and they look very friendly',
'The last time I bought a snack from a vending machine was a few days ago',
'Maybe it was last Friday, I bought a bag of chips for about 2 dollars',
'Yes, I would use a credit card to make a purchase at a vending machine',
'I hardly ever carry cash with me',
'Also, it\'s much more conveient to use a card rather than bills and coins',
'I would be mos tlikely to buy ice cream from a vending machine',
'Most vending machines have my favorite ice cream, so it\'s easy to find wherever I am',
'However, it takes me more time to choose movies or toys, so I\'d rather not buy them from a vending machine',
