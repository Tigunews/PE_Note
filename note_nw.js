...
# 엔트로피 <br/>\
- 개념 : 각 메시지에 포함되는 불확실성, 메시지 포함된 정보의 기대값(평균) <br/>\
- 수치 : 확률(낮) -> 정보(불확실) -> 정보 엔트로피(높음) <br/><br/>\
* 125회 관리 4교시 2번\
',

// 샤논의 제1정리
'# 정의 : 메시지 -> 가변부호 / 평균 부호 길이 최소값 = 엔트로피 <br/>\
- 정보원 부호화 정리(SourceCodingTheorem) <br/>\
- 어떤 정보원의 메시지를 순간 복호가 가능한 가변부호로 나타낼 때 평균 부호어 길이의 최소값은 그 정보원의 엔트로피와 같다는 정리 <br/><br/>\
# 개념도 <br/>\
<img src = "./img/SourceCodingTheorem.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 정리 <br/>\
- 정보원 부호화 정리 : 가변길이의 부호 >= 최소 엔트로피 / 데이터 부호화 위한 하한 제시 <br/>\
- 평균 부호어 길이 : 코드 길이 가변 평균 길이 <br/>\
- 엔트로피 : 정보를 표현하는 최소 구성되어야 하는 정보의 자원량 <br/><br/>\
* 125회 관리 4교시 2번\
',

// 샤논의 제2정리
'# 정의 : 데이터 정보율 > 채널 용량 / 에러/잡음 최소화 / 부호화 과정 존재 이론 <br/>\
- Channel Coding Theorem <br/>\
- 데이터가 채널용량보다 작은 정보율을 가지고 있다면, 에러/잡음을 최소화할 수 있는 부호화(Coding) 과정이 반드시 존재한다는 이론 <br/><br/>\
# 개념도 <br/>\
<img src = "./img/ChannelCodingTheroem.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 정리 <br/>\
1. R < C <br/>\
- 적정 부호화 기술 사용시 오류 최소화 가능 <br/>\
- 에러율 0으로 접근시키는 부호화 기법 존재 <br/><br/>\
2. R > C <br/>\
- 어떠한 부호화 기술 사용하더라도 에러 존재 <br/>\
- 에러율 어떤 값 이하로 줄일 수 없음 <br/><br/>\
* 125회 관리 4교시 2번\
',

// 샤논의 제3정리
'# 정의 : 전송 비트수 = 대역폭 * 전송시간 비례 / 제약조건상 신뢰 전달 최대 전송률 <br/>\
- 히틀리의 법칙 : 채널을 통해서 주어진 시간 내에 전송할 수 있는 통보의 전 비트수는 채널 대역폭과 전송시간의 곱에 비례한다는 법칙 <br/>\
- 샤논-하틀리의 정리 : 정보이론에서 채널모델 및 전송 제약조건이 주어진 상태에서 신뢰성 있게전달할 수 있는 최대 전송률을 의미 <br/><br/>\
# 수식 <br/>\
<img src = "./img/ShannonHartley.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 정리 <br/>\
- 채널용량 증가 : 대역폭(B), 신호전력(S) 증가 / 잡음전략(S) 감소 <br/>\
- 잡음-채널용량 : 잡음 유(채널 용량 무한), 잡음 무(채널용량 유한) <br/><br/>\
* 125회 관리 4교시 2번\
',
...
- 모든 네트워크 사업자와 정부는 인터을 통해 발생하는 데이터 트래픽을 동등하게 취급하고, 대상, 내용, 유형, 사용자, 플랫폼, 전송방식에 따른 어떠한 차별도 없이 동등하게 처리해야 하는 원칙 <br/><br/>\
# 찬성 반대 <br/>\
