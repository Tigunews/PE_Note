...
- 안전성 제공 (작은 크기 복잡 암호) <br/>\
- 다양성 : ECC 타원곡선 암호 총칭, 다양한 암호기술 존재 <br/><br/>\
# 장점 <br/>\
...
// GDPR
'# 정의 : 1995년 EU 개인정보보호 지침 제정후 규정된 개인정보보호 법령 (2018.5.25. 시행) <br/><br/>\
# 배경 및 목적 <br/>\
- EU 회원국간 개인정보보호 입법 불통일성 인한 통일 시행 필요 <br/>\
- 개인정보 보호(1조2항) + 자유로운 이동(1조3항) <br/><br/>\
# 구성 <br/>\
- 정보주체의 권리 : 열람청구건, 정정,삭제권, 정보이용권 <br/>\
- 정보처리자의 책무 : DPO(개인정보보호 책임자) 지정, 개인정보 영향평가 실시 <br/><br/>\
# GDPR 주요 변경사항 <br/>\
- 규정 효력 범위 : 권고 차원 -> 의무 사항 <br/>\
- 기업의 책임 강화 : 최소한 처리, 처리목적 통지 -> DPO 의무지정, 영향평가 추가 <br/>\
- 정보주체 권리 강화 : 열람 청구권, 삭제권 -> 정보 이동권 추가 <br/>\
- 과징금 부과 : 회원국별 자체 법규 -> 통일된 기준 <br/><br/>\
# GDPR 주요 골자 <br/>\
1. 주요용어 <br/>\
- 컨트롤러 : 개인정보 처리 목적,수단 결정가능한 개인 또는 단체 <br/>\
- 프로세서 : 컨트롤러를 대신하여 처리하는 개인 또는 단체 <br/><br/>\
2. 주요원칙 <br/>\
- 개인정보 처리원칙 : 적법성, 공정성, 투명성, 목적 제한, 최소화, 정확성, 무결성, 기밀성, 책임성 <br/>\
- 동의 : 자신의 개인정보 처리에 대한 의사 표현 <br/><br/>\
3. 정보주체의 권리 <br/>\
- 처리제한권 : 정보주체의 개인정보 처리 차단,제한 요구권리 <br/>\
- 정보이동권 : 다른사업자에게 전송토록 요구할 권리 <br/><br/>\
4. 기업 책임성강화 조치시항 <br/>\
- DPO 지정 : 전문지식, 임무수행능력 가진 독립성 지닌 개인정보보호 책임자 지정 <br/>\
- 개인정보처리 활동의 기록 : GDPR 준수 입증 위한 문서화 유지 <br/><br/>\
5. 개인정보 EU 역외 이전 <br/>\
- 표준계약 : 반영된 계약 통해 개인정보 이전하는 경유 <br/>\
- 의무적 기업 규칙 : 구속력 있는 의무적 기업규칙에 따라 이전하는 경우 <br/><br/>\
6. 과징금 <br/>\
- 일반적 위반사항 : 대리인 미지정 위반, 유출통지 위반, 개인정보 처리활동 기록 위반 등 <br/>\
- 중요한 위반사항 : 국외 이전 규정 위반, 개인정보 처리 기본원칙 위반, 정보주체의 권리 보장 의무 위반등 <br/><br/>\
# GDPR, 개인정보보호법 비교 <br/>\
<img src = "./img/GDPR_1.PNG" style = "max-width:auto: height:100%"><br/><br/>\
<img src = "./img/GDPR_2.PNG" style = "max-width:auto: height:100%"><br/><br/>\
# 국내 기업 준비사항 <br/>\
1. GDPR 적용 대상 여부 판단 <br/>\
- EU 주민 개인정보 처리 : EU 주민에게 물품,서비스 제공하는 기업 <br/>\
- EU 주민 민감정보 처리 : EU 주민 민감정보(건강, 유전자, 범죄경력), 아동 개인정보 <br/><br/>\
2. 즉시 개선 가능 사항 이행 <br/>\
- 핵심 인물 지정 : DPO, 역내 대리인 <br/>\
- 기록 유지,관리 : 처리활동에 대한 기록 유지,관리 <br/><br/>\
3. 업무 체계 보완 <br/>\
- 업무절차 개선 : 제반사항 점검 <br/>\
- 개인정보 영향평가 실시 : 권리,자유에 고위험 평가 실시하여 위험 완화 <br/>\
- 국외 이전 적법성 확보 : BCP, 유럽 개인정보보호인증 취득 통한 적법성 확보 <br/><br/>\
* 117회 컴시응 4교시 1번 \
',
