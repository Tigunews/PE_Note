...
// 코호트분석
'# 정의 : 마케팅 방법 / 세대별 분석 / 예측 <br/>\
- 소비자를 세대마다 구분하고, 세대별로 종래의 환경 · 소비 실적을 분석하여 장래의 소비 행동을 예측하는 마케팅 수법',
...
- BS25999 기반으로 제정된 BCMS에대한 국제 표준 <br/>\
- 사업 연속성을 수립,구현,운영,모니터,검토,유지보수,개선하는 전체 경영 시스템의 한 부분(TTA) <br/>\
- 재난이나 위기 상황에도 업무의 연속성을 확보하기 위한 관리체계<br/><br/>\
# 암기 <br/>\
- 2000년 러시아 핵잠수함 <br/>\
- 쿠르스크호 침몰사건 <br/>\
- 2001년 911테러 <br/>\
...
- A : 개 <br/><br/>\
# 도입배경<br/>\
- 2000년 8월 12일 러시아 핵잠수함 쿠르스크호 침몰사건, 2001년 911테러를 포함한 각종 자연재해의 위험이 대두되면서 국제 표준화 기구(ISO)는 사회 안전분야의 표준화 작업에 착수 <br/>\
- 2012년 5월 12일 ISO22301(비즈니스연속성경영시스템-요구사항) 국제표준 발간 <br/>\
- 2013년 2월 19일 KSA ISO 22301(사회안전-비즈니스 연속성 관리 시스템- 요구사항) 국가 표준 제정 <br/><br/>\
# 특징 : BSC25999-1 기반으로 ISO22313, BS25999-2기반으로 ISO22301로 제정되었으나, 현재 ISO22301만 인증규격으로 남아있으며, BS25999는 2012년 11월 폐지 <br/><br/>\
# 주요내용 <br/>\
- 준비 : 1. 적용범위, 2. 인증표준, 3. 용어와 정의 <br/>\
- 계획수립(Plan) <br/>\
4. 조직의 상황 : 4.1 조직 및 조직의 상황 이해, 4.2 이해관계자의 니즈 및 기대, 4.3 비즈니스 연속성 경영 시스템의 적용 범위 결정, 4.4 비즈니스 연속성 경영시스템<br/>\
5. 리더십: 5.1 리더십 및 의지표명, 5.2 경영자 의지표명, 5.3 방침, 5.4 조직의 역할, 책임 및 권한<br/>\
6. 기획, 6.1 리스크 및 기회를 다루는 조치, 6.2 비즈니스 연속성 목표 및 목표 달성 계획<br/>\
7. 지원, 7.1 자원, 7.2 역량/적격성, 7.3 인식, 7.4 의사소통, 7.5 문서화된 통보 <br/>\
- 실행 및 운영(Do) <br/>\
8. 운용 ; 8.1운용기획 및 관리, 8.2 비즈니스 영향분석 및 리스크 평가, 8.3 비즈니스 연속성 전략, 8.4 비즈니스 연속성 절차 수립 및 실행, 8.5 연습 및 시험 실시 <br/>\
- 모니터링 및 검토 (Check) : 9. 성과평가, 9.1 모니터링, 측정, 분석 및 평가, 9.2 내부심사, 9.3 경영검토 <br/>\
- 유지 및 개선(Act) : 10. 개선, 10.1 부적합 및 시정조치, 10.2 지속적 개선 <br/><br/>\
...
// 27
'# 정의 : 정보화사업 감리 / 3자 관점의 검증 활동 <br/>\
- 발주자와 사업자등의 이해관계로부터 독립된 자가 정보시스템의 효율성을 향상시키고 안전성을 확보하기 위하여 제3자의 관점에서 정보시스템의 구축 및 운영등에 관한 사항을 종합적으로 점검하고 문제점을 개선하도록 하는 활동 <br/><br/>\
# 암기 <br/>\
- 전자정부법 제57조 시71 <br/>\
- 사업비 5억 이상 <br/>\
- 1억 미만 예외 <br/><br/>\
- 3단계 : 요설종 <br/>\
- 2단계 : 설종 (20억 이하 or 6개월 미만) <br/><br/>\
- 점검기준 : 절산성 <br/>\
- 절 : 계절준 <br/>\
- 산 : 안준일기 <br/>\
- 성 : 충실 <br/><br/>\
- 공통감리 : 예현시 <br/>\
- 추가 전문가 점검 : 약접호취기 <br/><br/>\
- 목차 : 근목기개단항일인통행 <br/><br/>\
# 의무기준 : 전자정부법 57조(행정기관 등의 정보시스템 감리), 시행령 71조 <br/>\
- 대국민 서비스, 여러 중앙행정기관 공동 구축/사용, 정보시스템 구축사업으로 사업비 5억 이상 <br/>\
- 정보기술 아키텍처, 정보화 전략 계획 수립, 정보시스템 개발/운영 사업으로 감리 시행 필요하다고 해당 중앙행정기관의 장이 인정하는 경우 <br/>\
- 국가안전보장 관련 정보 취급하는 경우 (국방,외교,안보등 국가 안전보장관한 정보, 개인정보, 그밖 기밀 유지 또는 공신력 확보 필요로 기관장 인정 경우) <br/>\
- (예외) 사업비 1억 미만(HW,SW 단순구매 비용 제외) 소규모 사업으로 정보시스템 감리 비용 대비 효과 낮다고 중앙행정기관이 인정하는 경우 제외 가능 <br/>\
- (예외) 전자정부사업관리 위탁 & 사업비 1억이상 5억 미만 전자정부사업(대국민 서비스 행정업무/민원, 여러 중앙행정기관 공통 구축, 사용), 사업기간 5개월 미만 <br/><br/>\
# 감리기준 : 전자정부법 57조, 행정자치부 고시 <br/>\
- 감리보고서 : 감리법인이 감리 및 시행조치 확인 후 결과 기록한 보고서, 감리수행결과 보고서, 시정조치 확인 보고서 <br/>\
- 3단계 감리 : 요구정의, 설계, 종료 <br/>\
- 2단계 감리 : 설계, 종료 <- 사업비 20억 이하 or 사업기간 6개월 미만인 경우, 요구정의 생략 가능, 발주자(PMO) 대체 가능 <br/>\
- 상주 감리 : 감리대상 사업현장에 상주하거나 주기적으로 투입되는 감리원이 사업관리 업무지원, 자문 등을 수행하는 감리 <br/><br/>\
# 3단계 감리 <br/>\
1. 요구정의 : 요구사항의 완전성/ 정확성 <br/>\
2. 설계 : 대비표 변경여부, 세부검사 항목 구체화, 검사기준 적정성 <br/>\
3. 종료 : 과업이행여부 점검방안 수립, 과이여점 결과보고, 우선순위, 기능/비기능 요사 점검, 전수조사/표본추울 대상 수행 <br/><br/>\
# 감리 관점별 점검 기준 <br/>\
- 절차 : 계획 적정성, 절차 적정성, 준수성 (절-계절준) <br/>\
- 산출물 : 안전성, 준거성, 일관성, 기능성 (산-안준일기) <br/>\
- 성과 : 충족성, 실현성 (성-충실) <br/><br/>\
# 감리 최종 평가 방식 : 적합(결함 미발견/단순결함), 부적합(결함) <br/><br/>\
# 단계별 감리 : 예현시 <br/>\
- 예비조사 : 예비조사 > 감리계획서(안)검토 > 감리계획서 접수 <br/>\
- 현장감리 : 착수회의 > 감리시행 > 종료보고 > 감수결보제출 <br/>\
- 시정조치 : 감리결과 시정조치 > 시조 확보 제출 <br/><br/>\
# 추가 전문가 점검 <br/>\
- SW 보안 약점 진단 : 행자부 47개, 소스코드 보안약점 점검, 시큐어 코딩 가이드 준수, 점검 도구 활용 -> KISA 인증 보안약점점검원 수행 : 감리사 인증받아 병행하기도 함 <br/>\
- 웹 접근성 및 웹 호환성 진단, 웹 취약점 점검 : OWASP Top 10 기준, 전자정부 웹 서비스 취약점 대응 지침(행자부) <br/>\
- 기능점수 점검 : SW 사업저장소 저장 의무, 데이터 품질 진단, 기능 테스트(단위테스트) <br/><br/>\
# 감리 계획서 목차 <br/>\
1. 관련근거 <br/>\
2. 감리목적 <br/>\
3. 감리적용 기준 <br/>\
...
7. 감리일정 <br/>\
8. 투입인력 편성 <br/>\
9. 감리계획서 및 보고서 통보기관 <br/>\
10. 기타 행정사항 <br/><br/>\
# 감리원 자격 기준 <br/>\
1. 수석 감리원 : 국가 공인 정보 시스템 감리사, 정보처리 직무분야 기술사 <br/>\
2. 감리원 : 고급기술자(정보처리분야, 기사+5, 산업기사+10), 감리사유사자격(NIA감리인 인증서 취득자, 정보통신기술사, 정보보호 전문가 1급(+5), CISA정식자격자(+5) <br/><br/>\
* 감리는 "점검" 용어 필수 <br/>\
* 예비조사-총괄감리원 수행, 점검가이드 기반 테일러링 수행 <br/>\
* 원래는 발주사 1차 점검, PMO 2차점검, 감리 3차 점검으로 진행되어야 하나 현실은 응용 시스템 점검해보면 외부인터페이스 부분이 대부분 약함 <br/>\
* DB는 업무 특성이 강해서 점검 어려움, 표준 및 가이드를 기준으로 하며 요즘엔 데이터 품질도 점검해줌 <br/>\
* 보안은 시큐어 코딩등 점검해줌(PIA는 별도 진행하므로 제외) <br/>\
* 공공은 무조건 착수단계에서 FP 산정해서 SW 사업 저장소 저장 필요. 감리사가 요.설.종 3단계 걸쳐 점검해줌 <br/>\
* 감리는 종합적 점검활동을 수행하므로 중소기업에 더 필요함, 예산문제\
',
...
- 발주자가 특정 과제의 수행에 필요한 요구사항을 체계적으로 정리하여 제시함으로써 제안자가 제안서를 작성하는데 도움을 주기 위한 문서<br/><br/>\
# 작성 사항 : 사업개요, 제안 프로젝트 특징, 정보 요구내역, 기술적 환경 정의, 제안서 관련 요구사항 <br/><br/>\
<img src = "./img/RFP_1.png" style = "max-width:100%; height:auto;"><br/><br/>\
<img src = "./img/RFP_2.jpg" style = "max-width:100%; height:auto;">\
',
...
# 목차 예시 <br/>\
1. 제안 개요 <br/>\
2. 제안업체일반 : 일반현황, 조직 및 인원, 주요사업내용, 주요사업실적 <br/>\
