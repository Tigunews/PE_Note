...
// 파레토 법칙
'# 정의 : 2:8 법칙 / Web 1.0 <br/>\
- 전체 결과의 80%가 전체 원인의 20%에서 일어나는 현상 <br/><br/>\
# 동인 <br/>\
- 선택과 집중 / VIP 마케팅 <br/><br/>\
* ITPE 126회 FR 4일차 1교시 8번\
',

// 롱테일 법칙
'# 정의 : 반 파레토 법칙 / Web 2.0 (온라인 마케팅) <br/>\
- 80%의 비핵심 다수가 20%의 핵심 소수보다 더 뛰어난 가치를 창출한다는 이론 <br/><br/>\
# 특징 <br/>\
- 공급 측면 : 고정비용, 가변비용 유지 <br/>\
- 수요 측면 : 소비자 DB 분석, 재조명 <br/>\
- 장점 : 생산성 증가 <br/>\
- 단점 : 다양성 감소 <br/><br/>\
# 동인 <br/>\
- 생산도구 대중화 : 도구 제작자, 생산자 / 디지털 비디오 카메라, 블로깅 도구 <br/>\
- 유통구조 대중화 : 집산자 / 아마존, 이베이, 아이튠스, 넷플릭스 <br/>\
- 수요와 공급 연결 : 필터 / 구글, 블로그, 베스트 셀러 목록 <br/><br/>\
* ITPE 126회 FR 4일차 1교시 8번\
',
...
- Network : 3G, LTE, 5G <br/>\
- Device : Platform 탑재한 Device 출시 <br/><br/>\
# 표준 비교 <br/>\
...
# 목표 <br/>\
- 경영전략 : 핵심역량 집중화, 예산구조 유연성, 환경 변화 대응, 경쟁력 향상 <br/>\
...
# 수행방안 <br/>\
- 성공요인 : 포괄적 대응 및 유연성, 아웃소싱 역량, 이용자 중심 관계 관리 <br/>\
- 실패요인 : 단기실적 중심, 의사소통 부족, 부적절 서비스 수준, 자원 부족 <br/>\
- 문제점 : 통제 문제, 보안 문제, 업무 이해 부족 문제, 전략변경 문제, 의존성 문제 <br/>\
- 개선사항 : 적절 테스트, 보안수준 명확화, 유경험 업체 선정, 중장기 계획 기반 추진, 지속적 의견교환 <br/><br/>\
# 추진 프레임워크 <br/>\
- 사업 계획 수립 : 현황분석 및 조직구성, 사업계획서 작성 <br/>\
- 발주 및 계약 : 제안 요청, 사업자 선정 및 계약 체결 <br/>\
- 서비스 이전 관리 : 서비스 이전 <br/>\
- 서비스 수행관리 : 성과관리, 운영 유지보수 관리 <br/>\
...
- 장애관리 : 장애 발생시 빠른 시간내에 서비스가 정상화되도록 복구하여 비즈니스에 영향을 최소화 하는 활동 <br/><br/>\
# 절차 <br/>\
- 사고 감지 및 기록 : 보고된 Incident 기록 <br/>\
- 분류 및 초기지원 : Incident 분류, 긴급도 평가, 우선순위 지정 <br/>\
- 조사 및 진단 : Incident 세부 내용 평가, 분석 및 해결책 도출 <br/>\
- 해결 및 복구 : 임시, 영구 해결책 통한 복구 <br/>\
...
- 문제관리 : 문제의 근본 원인을 해결함과 동시에 그러한 문제들이 <font color = "red">재발되지 않도록</font> 하는 활동 <br/><br/>\
# 절차 <br/>\
- 문제 식별 및 기록 : 장애관리에서 이관된 문제 처리 요청 접수 <br/>\
- 분류 및 우선순위 : 사건 유형, 특성, SLA 따라 문제 유형 분류 <br/>\
- 조사 및 진단 : 근본 원인 분석 및 해결책 모색 <br/>\
- 해결책 식별 : 알려진 오류에 대한 해결방법 제시 <br/>\
- 문제해결 및 종료 : 동일한 문제 재발 방지, 종료된 문제 기록 <br/><br/>\
# 장애 관리, 문제 관리 비교 <br/>\
...
- IT 서비스 구성관리를 포함한 수집 및 처리된 지식을 기반으로 하는 IT 서비스에 대한 <font color = "red">조직의 의사결정 촉진</font> 관리 시스템 <br/><br/>\
# 구성 (P,KP,II,DI)<br/>\
- Presentation <br/>\
...
- 예산낭비 요인 : 기존 정보시스템 재활용 미흡, 중복구축 사업 추진 <br/><br/>\
# 필요성 <br/>\
...
# 검토 주요 내용 <br/>\
- 사업 타당성 : 필요성, 시급성, 중복성 <br/>\
- 실현 가능성 : 사업 추진 여건, 기술 적정성 <br/>\
- 규모 적정성 : 충족구비 적정성 <br/><br/>\
# 가이드 4판 개정사항 <br/>\
...
// 정보시스템 구축사업 이행방안 수립절차
'# 수립절차 및 산출물 <br/>\
1. 정보시스템 구축사업 계획 수립 <br/>\
- 설명 : 구축 범위 확정, 전략 수립, 조직 정의, 구축 사업 일정 <br/>\
- 산출물 : 내용, 기대효과, 전략, 체계, 계획 <br/><br/>\
2. 분리발주 가능성 평가 <br/>\
- 설명 : 관련 패키지 조사, 분리발주 가능성 분석 <br/>\
- 산출물 : 분리발주 가능성 평가 결과, 패키지 범위 <br/><br/>\
3. 정보시스템 예산 수립 <br/>\
- FP 산정, 예산 검토 <br/>\
- 산출물 : 예산 <br/><br/>\
4. 제안요청서(RFP) 작성 <br/>\
- 설명 : 목차, 세부내용, 검토 <br/>\
- 산출물 : RFP <br/><br/>\
5. 정보시스템 구축 업체 선정/평가 지원 <br/>\
- 설명 : 정보시스템 구축 업체 선정/평가 준비 <br/>\
- 산출물 : 구축업체 선정,평가 기준 <br/><br/>\
* 125회 관리 2교시 1번 \
',
...
'# 절차 <br/>\
1. 사전준비 <br/>\
- ISMP 컨설팅 대상 업무 범위 확정 <br/>\
- 산출물 : 컨설팅 대상 업무 요구사항 <br/><br/>\
2. 컨설팅 등급 결정 <br/>\
- 투입인력 컨설턴트 등급 결정 <br/>\
- 산출물 : 컨설턴트 등급 <br/><br/>\
3. 컨설팅 공수 계산 <br/>\
...
- 산출물 : 등급별 투입공수 <br/><br/>\
4. 컨설턴트 직접인건비 계산 <br/>\
- 직접인건비 = 등급별 공수 * 컨설턴트 평균 임금 <br/>\
- 산출물 : 직접인건비 <br/><br/>\
5. 제경비 및 기술료 계산 <br/>\
- 제경비 = 직접인건비 * 110~120% <br/>\
- 기술료 = (직접인건비 + 제경비) * 20~40% <br/>\
- 산출물 : 제경비, 기술료 <br/><br/>\
6. 직접경비 계산 <br/>\
- 컨설팅 업무 필요 직접경비 계산 <br/>\
- 산출물 : 직접경비 <br/>\
7. ISMP 컨설팅 대가 산정 <br/>\
- 대가 = 직접 인건비 + 제경비 + 기술료 + 직접경비 <br/>\
- 산출물 : 컨설팅 대가 <br/><br/>\
* 125회 관리 2교시 1번\
',
...
# 가치창출 체계 <br/>\
- 데이터 생산 > 정제,가공,유통 > 기업,정부,공공기관 활용 > 소비자,시민 혁신서비스 이용 <br/><br/>\
# 활성화 계획 <br/>\
...
# 개념도 <br/>\
<img src = "./img/SharedEconomyOverview.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 사례 <br/>\
<img src = "./img/SharedEconomyExample.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 긍정 부정요소 <br/>\
- 긍정요소 : 거래 자원 확대, 신 수요 시장 창출, 일자리 창출 <br/>\
- 부정요소 : 경제 위축, 시스템 인프라 부족 <br/><br/>\
# 공유경제 문제점 <br/>\
- 플랫폼 사업자 : 이윤 독점화 <br/>\
- 대여자 : 지하경제 규모 증가, 범죄 행위 <br/>\
...
// [RTE]- 사이클론 모델
'# 정의 : RTE 하부구조 / 지휘, 관리, 운영 관점 / 종단간 사이클 정의 모델 <br/>\
...
# 수행 활동 <br/>\
1. 전략적 활동 <br/>\
- 기업활동에 지침을 제시하는 선제적 의사결정<br/>\
- Segmentation, Targeting, Positioning <br/><br/>\
2. 기능적 활동 <br/>\
- 마케팅의 기능적 책임 제품/기술 개발기능 초점 <br/>\
- Product, Place, Promotion, Price <br/><br/>\
3. 전술적 활동 <br/>\
- 전략적, 기능적 의사결정 사항을 실행하기 위한 전술 개발 <br/>\
- 입소문, 틈새마케팅, 결합판매 <br/><br/>\
* 라이지움 88회 관리 1교시 8번\
',

// Digital Transformation
'# 정의 : AI, Cloud, BigData 활용 / 기업 비즈니스 모델 혁신 / 고객 중심 개인화 서비스 / 제공 활동 <br/>\
- AI, Cloud, BigData 등의 디지털 기술을 활용하여 기업 비즈니스 모델을 혁신해 고객 중심의 개인화된 서비스를 제공하는 활동 <br/><br/>\
# 필요성 <br/>\
...
# 추진 전략(VOGBI) : Vision > Organization > Governance > Business Model > Innovation <br/><br/>\
* KPC 97회 2교시 4번\
',

// [경영환경분석]- Horizon Scanning
'# 정의 : 데이터기반 / 위험요인, 기회요인 / 사전 탐지 활동 <br/>\
...
// [경영환경분석]- Backcasting
'# 정의 : 미래 목표 설정 / 현재시점 차이점 도출 / 전략 도출 기법 <br/>\
...
// 비재무 지표
'# 정의 : 기존 한계 극복 / 다양한 요소 연계 / 성과 지표 <br/>\
- 기존 재무 지표 중심의 성과 평가 한계 극복을 위해 전략, 동인, 목표, 환경 등 다양한 요소 연계한 성과 지표 <br/><br/>\
# 특징 <br/>\
1. 장점 <br/>\
- 목표성 : 장기적 관점 기업 목표 인식 가능 <br/>\
- 성공성 : 유형자산(대차대조표) < 무형자산(충성도, 지적 자본) <br/>\
- 예측성 : 미래 가치 반영 가능 (R&D) <br/>\
- 견고성 : 통제 불가 요소에 의한 영향 적음(환경, 우연) <br/><br/>\
2. 단점 <br/>\
- 난이도 : 개발에 많은 시간, 노력 소요 <br/>\
- 기준 부재 : 공통 기준 부재, 자의적 해석 가능 <br/>\
- 해석성 : 인과 관계 파악 어려움, 최종결과 도출 불가 가능성 <br/><br/>\
3. 극복방안 <br/>\
- 기업 : 기업 가치 창출 동인 이해 필요 <br/>\
- 팀 : 성과 동인, 정합성 연계 파악 필요 <br/>\
- 개인 : 구성원 행동 성과 영향, 밀접 연계 필요 <br/><br/>\
* ITPE 126회 FR 4일차 1교시 7번\
',
...
// BSC 전략맵
'# 정의 : BSC 기술, 전략 실행 과정 / 전략맵 <br/>\
- BSC 방법론 및 목적, 관리지표와 인과관계, 기업의 미션과 전략 달성 공헌 기술 및 전략 실행과정 전략맵 <br/><br/>\
# 절차 <br/>\
- 환경분석 : 거시, 산업, 경쟁 환경 분석 <br/>\
- 비전 및 전략 설정 : 환경분석 결과 -> 목표 달성 위한 설정 <br/>\
- 관점 설정 : 재고내학 <br/>\
- 전략목표 설정 : 비전, 전략 관점별로 나누어 설정 <br/>\
- 지표 생성 : 기업 전략과 관련된 성과지표 추출 <br/>\
- 지표 연계 : 평가지표사이 인과 관계, 재무성과 연계 정의 <br/>\
- 전략맵 작성 : 재고내학 Top Down, 관점당 선,후행 지표 결정, 지표간 연계성 고려 <br/><br/>\
# 지표 <br/>\
- 재무적 관점 : 생산 단위당 이익, 신제품 매출 비중 <br/>\
- 고객 관점 : 적시 배송률, 제품과 서비스 패키지화, 인적 네트워크 구축정도, 고객 문제 해결 능력 설정 <br/>\
- 내부 프로세스 관점 : 운영 효율성, 제품 혁신, 활용도 증대, 품질향상, 아웃소싱 지표 설정 <br/>\
- 학습 및 성장 관점 : 전략적 역량 개발, 가치 공유 문화, 지식 활용지표 <br/><br/>\
# 정량적 평가 위한 모델 수립 방법(시스템 다이나믹스) <br/>\
<img src = "./img/SystemDynamics.png" style = "max-width:100%; height:auto;"><br/><br/>\
* 125회 관리 3교시 6번 \
',
...
// ESG 경영
'# 정의 : 환경, 사회, 지배구조 / 비재무적 지속가능성 / 제고 경영 방식 <br/>\
- Environment, Social, Governance <br/>\
- 기업 경영에서 과거에는 재무적 성과만을 평가하던 것을 벗어나 친환경, 사회적 책임, 지배구조 개선 방식 등의 비재무적 요소 통해 지속가능성 제고하는 경영방식 <br/><br/>\
# 구성요소 <br/>\
- Environment : 기후변화, 탄소배출, 환경규제, 에너지효율, 자원 폐기 관리 <br/>\
- Social : 고객만족, 데이터 보호,프라이버시, 근로자 안전, 지역사회 관계 <br/>\
- Governance : 청렴,기업윤리, 컴플라이언스, 이사회 구성, 공정 경쟁 <br/><br/>\
# 필요성 <br/>\
- 사회적 : 환경 문제 관심, 규제 강화, 투자자 요구 증가 <br/>\
- 기업적 : 기업신용평가, 고객 ESG 요구 <br/><br/>\
# 역할 <br/>\
1. 환경 <br/>\
- 온실가스 배출감소 : 탄소배출 감소시스템, 데이터센터 운영 최적화, 클라우드 확대 <br/>\
- 신재생 에너지 확대 : 디지털 발전소 구축, 에너지 AI 제어 <br/><br/>\
2. 사회 <br/>\
- 중소 협력사 동반성장 : 신기술 및 특허 이전, 설비 및 서비스 공동 사용 플랫폼 운영 <br/>\
- 고객중심 경영 : 인간중심의 기술 설계, 고객 정보보호 및 사이버 보안 <br/><br/>\
3. 지배구조 <br/>\
- 공정경쟁 : IT-BSC 지표 개발, 디지털 플랫폼 구축 <br/>\
- 기업윤리 : 레그테크, FDS <br/><br/>\
# 구축 전략 <br/>\
1. ESG Vision & Target 설정 <br/>\
2. 목표달성 위한 전략 수립 및 추진과제 도출 <br/>\
3. 전략과제 실행 위한 Management Infra 구축 <br/>\
4. 대내외 이해관계자 Communication 체계 확립 <br/><br/>\
* ITPE 8회 관리 2교시 1번\
',
...
// 악마의 강
'# 정의 : 아이디어 부재 / <font color = "red">연구단계 머무름 현상</font> <br/>\
...
// 죽음의 계곡
'# 정의 : <font color = "red">상업화 어려움</font> 현상 <br/>\
...
// 다윈의 바다
'# 정의 : <font color = "red">경쟁 어려움</font> 현상 <br/>\
...
// 그로스 해킹
'# 정의 : 지표 지속 분석 / 흐름 최적화 / 유저 확보 / 전략적 마케팅 기법 <br/>\
- Growth Hacking<br/>\
...
- Biz : <font color = "red">시민</font>들이 신속하고 창의적으로 협업하여 <font color = "red">공공의 문제</font>를 해결하고 도시를 더 살기 좋은 곳으로 만들기 위한 <font color = "red">운동</font> <br/>\
- IT : 다양한 <font color = "red">시민</font>들이 모여 디지털 기술을 활용해 <font color = "red">정부가 해결하지 못하는</font> 공공의 문제를 풀어내자는 <font color = "red">사회운동</font> <br/><br/>\
# 개념도 <br/>\
...
- 스스로 필요한 것을 만드는 사람들인 메이커가 기존의 <font color = "red">자작 취미생활</font>과 달리 컴퓨터, 인터넷, 디지털 생산도구를 이용해서 <font color = "red">산업 영역</font>까지 아우르는 특징을 지닌, 만드는 법을 공유하고 발전시키는 흐름<br/><br/>\
...
// 메이거 스페이스
'# 정의 : 즉석 작업 공간 <br/>\
- 3D 모델 파일과 다양한 재료들로 소비자가 원하는 사물을 <font color = "red">즉석</font>에서 만들어(printing)낼 수 있는 작업 공간',

// 인터넷 거버넌스
'# 정의 <br/>\
- 기술적(Descriptive) : 사회 행위자 상호작용 / 집단적 규칙, 절차, 프로그램 <br/>\
...
- 인터넷 거버넌스는 기술적 차원의 발전에 힘입어 진행된 복잡한 관리문제를 해결하기 위해 지속적으로 논의 되고 있는 <font color = "red">글로벌 차원의 정치적 관리 매커니즘</font><br/><br/>\
# 핵심 기능 <br/>\
...
- DWDM (Dense Wavelength Division Multiplexing) : 고밀도 파장 분할 다중화 <br/><br/>\
# 유형 <br/>\
1. 복구시간별 유형 <br/>\
- Mirror site : 동일 환경, 실시간 복제 / RTO 0 <br/>\
- Hot site : 주 센터 규모 환경, Active-Stand by / RTO 수시간 <br/>\
- Warm site : 주 센터 주요 장비 확보, 주요 업무만 복구 / RTO 수 일 <br/>\
- Cold site : 주 센터 데이터 보관/소산, 재해시 시스템 신규 설치 / RTO 수주, 개월 <br/><br/>\
2. 운영 형태별 유형 <br/>\
- 상호게약 : 유시가관간 계약, 비상지 지원 <br/>\
- 공동이용 : 여러기관 공동 출자, 백업센터 운영 <br/>\
- 외부위탁 : 재해복구 전문 서비스 업체 위탁 운영 <br/>\
- 독자 구축 : 자체 구축 / 운영 <br/><br/>\
# 고려사항 <br/>\
1. 비즈니스 측면 <br/>\
- 비용성 : 구축 비용, 환경 고려 방법 <br/>\
- 가치성 : 기업의 가치 제고 가능 방안 <br/>\
- 안정성 : ITIL 등 표준 절차 도입 <br/><br/>\
2. 시스템 측면 <br/>\
- 운용성 : 기존 시스템 호환성 고려 <br/>\
- 복구성 : 복구 시간, 효율성 제고 방안 마련 <br/>\
- 확장성 : 향후 주 시스템 확장 고려 계획 <br/><br/>\
# 구축 절차 <br/>\
- 업무 영향 분석 : 재해 인한 파급 영향 분석, 복구 우선순위 선정 <br/>\
- 복구 전략 수립 : 대상별 복구 전략, 솔루션 선정, 재해 복구센터 위치 및 유형 선정 <br/>\
- 복구 계획 수립 : 재해복구 시스템 구축 및 복구 위한 상세 시나리오 수립 <br/>\
- 모의 훈련 : 주기적 테스트, 미비점 보완 <br/><br/>\
# 도입 효과 <br/>\
- 재무적 측면 : ROI, TCO <br/>\
- 고객 측면 : 품질, 서비스 만족 <br/>\
- 프로세스 측면 : 생산성, 효율성 \
...
'# 정의 : 경계 소멸 현상<br/>\
- Big Blur <br/>\
- 인공지능, 빅데이터, 사물인터넷 등 첨단 정보통신기술의 발달로 인하여 기존에 존재하는 것들의 경계가 모호해지는 현상 <br/><br/>\
# 사례 <br/>\
1. 유통 <br/>\
- 디지털 컨버전스 : 온라인 서비스, O4O <br/>\
- 플랫폼화 전략 : 편의점, 약국, 생활용품점 <br/>\
- PB 상품 : 편의점, 대형마트, 온라인 쇼핑 <br/><br/>\
2. 금융 <br/>\
- 은행 : 핀테크, 모바일 은행 <br/>\
- 보험 : 핀테크, 인슈어 테크 <br/>\
- 신용카드 : 전략적 제휴, 스마트 캐시 적립 혜택 <br/><br/>\
* 라이지움 93회 관리 1교시 6번\
',

// 옴니채널
'# 정의 : 다중 유기적 결합 / 일관 경험 제공 서비스 <br/>\
- 온라인, 오프라인, 모바일등의 다양한 경로를 넘나들며 상품을 검색하고 구매할 수 있도록 여러 개(Multi)의 쇼핑채널을 소비자 중심의 전체(Omni) 관점에서 빈틈 없이 유기적으로 결합해 <font color = "red">일관된 경험</font>을 제공 서비스<br/><br/>\
...
- 비콘 : 블루투스 기반 최대 100m 거리 인식 가능, 실내 위치 파악 / 쇼핑정보, 쿠폰 전송\
',
...
# 확산배경 : 제조업의 서비스화, 인건비 상승, 물류 및 Time To Market 경쟁력 강화, 원재료/에너지 비용 변화(Shale Gas), 가치사슬간 협력 통한 혁신 역량 강화<br/><br/>\
# 리쇼어링 동인(Motive) <br/>\
...
# 원인 (<font color = "red">예시가공</font>)<br/>\
...
- 공급부족과 할당 : 수요가 공급 초과시 / 소매상 초과 주문 <br/><br/>\
# 방안 : CPFR <br/><br/>\
* KPC 66회 관리 4교시 3번\
',
...
- <font color = "red">심리학</font>과 <font color = "red">행동경제학</font> 분야의 용어로, 상대방의 행동을 변화시키는 유연한 방식의 선택 설계 이론 <br/><br/>\
# 원리 (<font color = "red">D실매체피인</font>)<br/>\
1. Default <br/>\
...
// KANO Model
'# 정의 : 기대(x), 충족(y) 관계 / 상품 기회 분석 방법 <br/>\
...
- <font color = "red">엔지니어</font>만 있는 스타트업에서 발생하는 <font color = "red">기술편향</font>을 비유하며 유사 개념으로 <font color = "red">“보트 네이밍”</font> 존재',

// IT 투자 관리
'# 정의 : 추정 / 판정 / 분석 활동 <br/>\
- 기업 혹은 기타 조직에서 정보기술을 활용한 시스템을 도입했을 때 정보화 투자에 대한 효과를 추정하고, 정보화 투자의 적정성을 검토 판정하는 IT 투자 효과 분석 활동 <br/><br/>\
# 필요성 <br/>\
- IT 생산성 패러독스 : IT 투자, 생산성 증가 사이 상관 관계 모호 <br/>\
- IT 투자평가의 중요성 : 조직의 사업전략, 재무적 성과간 투자효과성 측정 중요 <br/>\
...
# 지표 <br/>\
1. 품질지표 <br/>\
- 정보 품질 : 정확성, 중요성 등 정보시스템 제공하는 정보 대한 지표 <br/>\
- 시스템 품질 : 적시성, 신뢰성 등 정보 시스템 자체 품질 지표 <br/><br/>\
2. 이용지표 <br/>\
- 정보시스템 활용도 : 업무 프로세스 및 운영 통해 활용 평가 <br/>\
- 사용자 만족도 : 사용자 부서 평가 지표 <br/>\
- 접속시간 : 사용시간, 사용횟수, 로그 기록 활용도 평가 <br/><br/>\
3. 효과지표 <br/>\
- 업무 성과 향상도 : 투자 전/후 성과 향상 평가 지표 <br/>\
...
// 규제 샌드박스
'# 정의 : 신기술 시장진출 / 혁신성, 안전성 / 시장진출 기회 제공, 실증 테스트 허용 / 혁신의 실험장 <br/>\
- 신기술과 신서비스의 원활한 시장진출을 지원하기 위해 혁신성과 안전성을 바탕으로 시장진출의 기회를 주거나, 시간과 장소, 규모에 제한을 두고 실증 테스트를 허용하는 혁신의 실험장 <br/><br/>\
# 규제 샌드박스 절차 <br/>\
- 규제특례 신청 : 신청자->과기정통부장관 <br/>\
- 특례부여 검토 및 결정 : 관계기관의 장 + 신기술,서비스 심의위 -> 과기정통부장관 <br/>\
- 실증(2년 이하) : 과기정통부 + 관계기관 <br/>\
- 법령정비(필요시) : 관계기관의 장 <br/><br/>\
<img src = "./img/SandBox.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 기대효과 <br/>\
- 기업 : 글로벌 혁신경쟁 우위 선점 <br/>\
- 소비자 : 혁신 제품, 서비스 대한 선택권 확대 및 편리성 향상 <br/>\
- 정부 : 시범사업 결과 통한 정교한 규제체계 설계 가능 <br/><br/>\
# 규제혁신 5법 <br/>\
<img src = "./img/SandBoxRuleBase.png" style = "max-width:100%; height:auto;">\
',
...
# 절차 <br/>\
- Function 도출 : 영업단계 부터 최종 고객 서비스 단계 까지 모든 기능 발굴 <br/>\
- Value Chain 역할자 도출 : 현행 수행 조직 연계, 역할자 도출 <br/>\
- 가치창조 요건 정의 : 역할자 역할 정의, 인터뷰, 설문 조사 <br/>\
- 개선점 파악 : 가치 부가 증대 방안, 개선점 도출 <br/>\
- 접근전략 도출 : 비즈니스 측면, 정보기술 측면 접근 전략 수립 <br/><br/>\
# 유의사항 <br/>\
- 일반적 기업의 조직 구조, 회계시스템, SBU(Strategic Business Unit) 분류 않음 <br/>\
- SBU 독립 정의 vs SBU 전체 가치 사슬 지원 -> 후자 선택 <br/><br/>\
# RTE 사례 <br/>\
<img src = "./img/ValueChainExample.png" style = "max-width:100%; height:auto;"><br/><br/>\
* 124회 관리 1교시 1번\
',
