...
- Cohort Analysis : 특정기간 동안 동일한 특성을 가진 상요자 집단을 그룹으로 나눠서 그룹간의 차이를 보기 쉽게 분석하는 방법<br/><br/>\
# 절차 (기분인)<br/>\
1. 기준 수립 <br/>\
- 사용자 분류 기준 수립 <br/>\
...
- 기업의 투명성 강화, 리스크 관리를 위하여 정부나 관련 기관이 제시한 각종 규제, 법안 등에 만족될 수 있도록 IT 관점에서 시스템을 재 정비하는 활동 <br/><br/>\
# 주요 요구사항 (공보보통책)<br/>\
- 공개 : 투명성 제고 <br/>\
- 보존 : 이력 추적 <br/>\
- 보호 : 암호화, 접근 제어 요구 <br/>\
