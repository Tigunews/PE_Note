...
'[감리] 감리를 초반에 수행할 때와 후반에 수행할 때의 장단점에 대해 말씀해보시오',
'PMO의 역할과 필요성',
...
'프로젝트에서 어떤 위험이 있었고 대응방법이 무엇인지 설명',
'마이데이터 정의, 특징, 활용분야',
'쿠버네티스에 대해 답변 부탁드립니다.',
'경영, 경제',
'효율성, 효과성',
...
'마스터 데이터, 메타 데이터',
'저작권, 산업 재산권, 신지식 재산권',
'의료기관 랜섬웨어 감염 원인 2가지, 대응방안',
'물리적 망분리에 대한 기술사로써의 해결방안 제시하시오',
'모놀리식 아키텍처와 MSA 아키텍처를 비교해보세요',
'MSA 3가지 주요 기술에 대해 설명해보세요',
'CNN 과 R-CNN 의 차이점은?',
'규제 샌드박스에 대해 설명해주세요',
'FTP 보안에 대해 설명해주세요',
'비식별조치 가이드 라인에 대해서 설명 바랍니다.',
'OLTP와 OLAP 차이에 대해서 설명해주세요',
'정보시스템 감리에 대해서 설명해주세요',
'정보시스템 감리와 PMO의 차이점에 대해 설명해주세요',
'앞으로 기술사가 되실건데 기술사로써의 PM의 역할에 대해서 말씀해주세요',
'프로젝트가 수행시 일정이 지연되게 되면 프로젝트 관리자로써 어떻게 대응해야 하는지 설명해주세요',
'클라우드 보안 인증제도 인증 종류 및 평가절차 설명',
'IT 경영전략 중 최근 ESG가 화두이다. 면접자께서 의료계에 ESG를 적용하신다면 어떻게 하실것입니까?',
'4정규화 5정규화 반정규화',
'VPN을 설명해주시고, SSL VPN을 같이 설명해주세요',
'시스템과 서비스와 플랫폼의 차이를 말씀해주세요',
'디지털 세에 대한 본인의 의견을 말씀해주세요',
'취약점과 약점에 대해서 설명해주세요',
'분류와 회귀 는 어떤 학습인가?',
'FP를 많이 이용하고 있는데 데이터, 트랜잭션의 기능 유형에 대해 설명해보세요',
'SDLC 단계별 컴포넌트 산출물 설명',
'최근 화두가 되고 있는 플랫폼 규제에 대한 개인적 견해를 말씀해보세요',
'ASIL의 구성요소에 대해 말해보세요',
'메타버스와 메타버스 이슈에 대해 설명해보세요',
'기능점수와 DET, RET에 대해 설명해보세요',
'프로젝트 종료시 기능점수를 변경해야 하는 이유',
'클라우드 컴퓨팅과 에지 컴퓨팅 차이점에 대해 설명해보세요',
'CCTV 보안에 대해 설명해보세요',
'기술사법 개정 이슈를 설명해주시고 본인의 생각을 말씀해보세요',
'SW 아키텍처가 무엇이고 분석/설계시 주요 산출물을 말해주세요',
'망분리 근거와 대상, 본인이 수행한 망분리 경험을 말씀해주세요',
'4차 산업혁명 기술이 많은데 그 중 파급력이 가장 클 것이라고 생각하는 기술과 이유는?',
'데이터 라벨링이 무엇이며 중요한 점은 무엇인가?',
'DB 무결성은 무엇인지 설명해보시고, 실무에서는 어떻게 적용되는지 설명해보세요',
'디지털 트윈에 대해 설명해주시고, 세부 기술을 말씀해주세요',
'PM은 얼마나 했는지?',
'어플리케이션을 구현알 데이터베이스 구현시에 RDBMS와 NoSQL을 어떤 경우에 적용하는게 좋을지 설명해보세요',
];