...
먼저 기술적 측면입니다. 한국형 HL7을 기반으로 OCS/EMR 프로그램 설계시 이를 컨버팅 가능 토록 기존 시스템에 모듈화한 형태로 추가 개발 하거나, 신규 구축시엔 위 표준을 고려하여 설계하는 방향으로 고려햐애 합니다. <br/>\
다음으로 정책적 측면입니다. 현재 의료 데이터 표준화를 위해 정책적으로 EMR 인증심사 제도가 상급 종합병원을 중심으로 진행되고 있습니다. 이를 지역 병원들로 점차 확대하여 국가 의료 데이터 표준화를 이뤄야 한다고 생각합니다.\
',
...
'본 사업에서의 예측 적중률은 현재 데이터 수집 단계이며, 향후 충분한 데이터 해석결과가 충분히 나와야 적중률에 대한 해석이 가능한 것으로 알고있습니다. \
',
